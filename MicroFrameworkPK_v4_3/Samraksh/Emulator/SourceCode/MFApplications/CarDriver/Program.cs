...
namespace CarDriver
{
    ...
    public class Program
    {
        ...
        Program()
        {
            ...
            try
            {
                phyiscalModelPort = new SerialPort("COM2");
                phyiscalModelPort.Handshake = Handshake.None;
            }
            catch (Exception e)
            {
        ...
        void SendModelInput()
        {
            ...
            phyiscalModelPort.Write(buffer, 0, buffer.Length);
            /*
            if (n <= 0)
            {
        ...
        {
            Start();
            //Thread.Sleep(3000); //Drive Straight for 5s
