...
namespace Samraksh.AppNote.Scarecrow.Radar
{
    ...
    public partial class Program
    {
        ...
        private static void SetupBuffers()
        {
            ...
            radarDetect.SetDetectionParameters(Samraksh.eMote.RADAR_NOISE_CONTROL.SCALING_NOISE_REJECTION_TARGET, 7, 6, 2, 3, 6, 1);
            //radarDetect.SetDetectionParameters(Samraksh.eMote.RADAR_NOISE_CONTROL.FIXED_NOISE_REJECTION, 7, 16, 2, 3, 6, 1);
            //radarDetect.SetDetectionParameters(Samraksh.eMote.RADAR_NOISE_CONTROL.SCALING_NOISE_REJECTION_MULTIPLY, 7, 1.3, 3, 4, 6, 1);
        ...
        private static void ProcessBuffers(IQ iq)
        {
            ...
            var iBuff = iq.IBuff;
            var qBuff = iq.QBuff;
            bool detection = radarDetect.DetectionCalculation(iBuff, qBuff, ADCBufferSize, arcTan);
