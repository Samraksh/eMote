...
namespace BumbleBeeDetectionRadio
{
    public class Detection
    {
        static AnalogInput adcI = new AnalogInput(EmoteDotNow.ADC_Channel1);
        static AnalogInput adcQ = new AnalogInput(EmoteDotNow.ADC_Channel2);
        static Samraksh.SPOT.Net.Mac.CSMA csmaObject = new Samraksh.SPOT.Net.Mac.CSMA();
        ...
        {
            public static OutputPort Gpio0 = new OutputPort((Cpu.Pin)EmoteDotNow.GPIO_J12_PIN1, false);
            public static OutputPort Gpio1 = new OutputPort((Cpu.Pin)EmoteDotNow.GPIO_J12_PIN2, false);
        }
        ...
        public static void Main()
        {
            ...
            for (; ; )
            {
                //Debug.Print("Main thread will sleep forever");
        ...
        static void sampleFired(object o)
        {
            ...
            SensorData.currSample[0] = (ushort)adcI.Read();
            SensorData.currSample[1] = (ushort)adcQ.Read();
            ...
            if (SensorData.sampNum >= (int)DETECTOR.SAMPRATE * (int)DETECTOR.DC_EST_SECS)
            {
                ...
                /*
                SensorData.tempPhase = Phase.unwrap(SensorData.compSample) / 4096;
