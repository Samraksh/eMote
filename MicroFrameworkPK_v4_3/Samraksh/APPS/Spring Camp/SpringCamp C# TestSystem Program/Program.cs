...
namespace Samraksh.AppNote.DataCollector.Radar {
    ...
    public partial class Program
    {
        ...
        private static void SetupBuffers()
        {
			...
			// **** NOTE: the software uses a 0.5 second window (only 125 samples at a rate of 250 samples per second)
			// so the threshold here *should* be divided in half in the algorithm but it isn't.
			// Effectively this doubles the threshold programmed, so with a 7 threshold used as a parameter below we end up with an actual
			// threshold of 14.
            radarDetect.SetDetectionParameters(7, 30, 0,12);
