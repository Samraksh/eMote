    ...
    namespace eMote
    {
        namespace Net
        {
            struct MACBase
            {
                ...
                static UNSUPPORTED_TYPE& Get_NeighbourList( CLR_RT_HeapBlock* pMngObj )    { return Interop_Marshal_GetField_UNSUPPORTED_TYPE( pMngObj, Library_Samraksh_eMote_Net_Samraksh_eMote_Net_MACBase::FIELD__NeighbourList ); }
