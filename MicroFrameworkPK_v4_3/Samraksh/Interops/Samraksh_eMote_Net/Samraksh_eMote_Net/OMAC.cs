...
namespace Samraksh.eMote.Net.MAC
{
    ...
    public class OMAC : MACBase
    {
        ...
        public OMAC(IRadioConfiguration radioConfiguration, uint neighborLivenessDelay = 180 * 1000, byte numberOfRetries = 0, byte bufferSize = 8, bool cca = true, byte ccaSenseTime = 120)
