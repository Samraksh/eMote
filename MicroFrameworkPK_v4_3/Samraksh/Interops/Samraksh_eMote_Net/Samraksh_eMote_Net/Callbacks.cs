...
namespace Samraksh.eMote.Net
{
    ...
    {
        //private static ReceiveCallBackEverythingElse _macPipeReceiveCallBack = null;
        ...
        //private static MACPipe _macPipe = new MACPipe();

        /*public static void MACPipeReceiveCallback(ReceiveCallBackEverythingElse callback)
        {
            _macPipeReceiveCallBack = callback;
        }*/
        ...
        /*public static void ReceiveFunctionEverythingElse(uint data1, uint data2, DateTime time)
        {
            //if (_macPipeReceiveCallBack == null)
                //throw new CallbackNotConfiguredException();
            ...
            {
                //_macPipeReceiveCallBack();
                _macPipe.MACPipeCallback((UInt16)data2);
            }
        }*/
    }
}
