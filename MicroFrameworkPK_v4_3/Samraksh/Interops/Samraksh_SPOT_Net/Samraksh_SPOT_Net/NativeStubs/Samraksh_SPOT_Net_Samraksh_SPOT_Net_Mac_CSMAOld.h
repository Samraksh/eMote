...
#ifndef _SAMRAKSH_SPOT_NET_SAMRAKSH_SPOT_NET_MAC_CSMAOLD_H_
#define _SAMRAKSH_SPOT_NET_SAMRAKSH_SPOT_NET_MAC_CSMAOLD_H_
...
#endif  //_SAMRAKSH_SPOT_NET_SAMRAKSH_SPOT_NET_MAC_CSMAOLD_H_
