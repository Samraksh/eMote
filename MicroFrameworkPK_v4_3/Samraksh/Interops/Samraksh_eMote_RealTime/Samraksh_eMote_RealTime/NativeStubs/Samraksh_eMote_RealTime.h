...
#ifndef _SAMRAKSH_EMOTE_REALTIME_H_
#define _SAMRAKSH_EMOTE_REALTIME_H_

#include <TinyCLR_Interop.h>
struct Library_Samraksh_eMote_RealTime_Samraksh_eMote_RealTime_Timer
{
...
#endif  //_SAMRAKSH_EMOTE_REALTIME_H_
