...
public:
    ...
    static const INT32 MAX_MSG_PAYLOAD = COMM_BUFFER_SIZE - (sizeof(simple_payload_t) - 1);
    static const INT32 MAX_ADDPACKET_DATA = MAX_MSG_PAYLOAD - 4*sizeof(CLR_UINT32); //TODO: FIXME: use actual offsetof(MFUpdate_AddPacket)?. On 20170413, MAX_ADDPACKET_DATA is probably 80.
