...
public:
	...
	DeviceStatus ClearNeighbor(UINT16 nodeId)
	{
		UINT8 tableIndex;
...
//AnanthAtSamraksh -- moving all implementations inside class, due to compiler (4.4.1) complaining that there are multiple definitions.
#if 0
