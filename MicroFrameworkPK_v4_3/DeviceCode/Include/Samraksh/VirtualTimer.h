...
public:
	// Mutators for all the attributes of VirtualTimer Object
	...
	BOOL operator>(const VirtualTimer &other) const
	{
...
public:
	...
	VirtualTimer m_timer[NUM_VIRTUALTIMER_TIMERS];

	Hal_Heap_KnownSize<VirtualTimer*,NUM_VIRTUALTIMER_TIMERS , TimerCompare<VirtualTimer*> > timerQueue;

	UINT16 m_current_timer_id_;

	VirtualTimer *m_active_timer;
	...
	Hal_Heap_KnownSize<VirtualTimer*, NUM_VIRTUALTIMER_TIMERS, TimerCompare<VirtualTimer*> >* GetTimerQueue()
	{
		return &timerQueue;
	}
