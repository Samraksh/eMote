...
#define OMAC_DEBUG_PRINTF_RADIOADDRESS 1
#define OMAC_DEBUG_PRINTF_PACKETREC 0
#define OMAC_DEBUG_PRINTF_ACKREC 1
...
#define OMAC_DEBUG_PRINTF_PACKET_ACK_RX_FAIL 1
...
private:
  ...
  private:
	...
	UINT32 RETRANS_DELAY_DUE_TO_MISSING_ACK;
	UINT32 DELAY_IN_RECEIVING_ACK;
	UINT32 DELAY_IN_RECEIVING_HW_ACK;
	UINT32 DELAY_IN_RECEIVING_SW_ACK;
	UINT32 RETRANS_DELAY_DUE_TO_MISSING_HW_ACK;
	UINT32 RETRANS_DELAY_DUE_TO_MISSING_SW_ACK;
	UINT32 DELAY_FROM_RADIO_DRIVER_TX_TO_RADIO_DRIVER_RX;
    UINT32 DELAY_FROM_OMAC_TX_TO_RADIO_DRIVER_TX;
    UINT32 CCA_PERIOD_DESIRED;
    UINT32 CCA_PERIOD_ACTUAL;
    UINT32 RADIO_TURN_ON_DELAY_TX;
    UINT32 RADIO_TURN_ON_DELAY_RX;
    UINT32 TIME_RX_TIMESTAMP_OFFSET_MICRO;
...
//	static const UINT8 SlotLength = 8; //slot Length in milliseconds
  ...
  public:
	...
	UINT32 ACK_TX_MAX_DURATION_MICRO;
	UINT32 MAX_PACKET_TX_DURATION_MICRO;
	UINT32 MAX_PACKET_RX_DURATION_MICRO;
	UINT32 DISCO_PACKET_TX_TIME_MICRO;
	UINT32 DISCO_SLOT_PERIOD_MICRO;
	UINT32 DISCO_BEACON_TX_MAX_DURATION_MICRO;
	UINT32 HIGH_DISCO_PERIOD_IN_SLOTS;
