...
#define EXTRA_DELAY_IN_WAITING_FOR_ACK 0.6*MICSECINMILISEC
...
#define LISTEN_PERIOD_FOR_RECEPTION_HANDLER 	GUARDTIME_MICRO+GUARDTIME_MICRO+OMAC_TIME_ERROR+DELAY_FROM_OMAC_TX_TO_RF231_TX+EXTENDED_MODE_TX_DELAY_MICRO+ACK_DELAY+EXTRA_DELAY_IN_WAITING_FOR_ACK
...
#define FAST_RECOVERY_WAIT_PERIOD_MICRO 4*MICSECINMILISEC
