...
#define GUARDTIME_MICRO 1000			//compensate for time-sync errors; accounts for the clock drift
...
#define FORCE_REQUESTTIMESYNC_INTICKS 960000000					//Translates to 120 secs @8Mhz. Receiver centric time threshold to request for a TImeSync msg.
#define SENDER_CENTRIC_PROACTIVE_TIMESYNC_REQUEST  80000000		//Translates to 10 secs @8Mhz. Sender centric time threshold to send a TImeSync msg.
