...
#define SELN_PIN_LR		51
#define RSTN_PIN_LR		51
#define SLP_TR_PIN_LR   50
#define AMP_LR			50
#define INTERRUPT_PIN_LR 52
...
enum Rf230TrxRegisterEnum {
  ...
  RF230_BUSY_TX = 2,
  RF230_RX_ON = 6,
  RF230_TRX_OFF = 8,//AnanthAtSamraksh - changed from 8 to 3 then to 2 (as per page 175 in the data sheet)
  RF230_PLL_ON = 9,
  RF230_SLEEP = 15,
...
enum Rf230SpiCommandEnums {
  ...
  RF230_CMD_REGISTER_READ = 0x80, //AnanthAtSamraksh - changed from 0x80 to 00
  RF230_CMD_REGISTER_WRITE = 0xC0, //AnanthAtSamraksh - changed from 0xC0 to 00
