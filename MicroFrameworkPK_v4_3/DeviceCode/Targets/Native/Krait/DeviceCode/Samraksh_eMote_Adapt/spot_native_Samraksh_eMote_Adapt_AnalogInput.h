...
#ifndef _SPOT_NATIVE_SAMRAKSH_EMOTE_ADAPT_ANALOGINPUT_H_
#define _SPOT_NATIVE_SAMRAKSH_EMOTE_ADAPT_ANALOGINPUT_H_
...
#endif  //_SPOT_NATIVE_SAMRAKSH_EMOTE_ADAPT_ANALOGINPUT_H_
