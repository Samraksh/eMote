...
INT16 AccelerometerInternal::ADAPT_Accel_GetTemperature( CLR_RT_HeapBlock* pMngObj, HRESULT &hr )
{
	UINT8 data;
	...
	samraksh_i2c_read_reg(BMA250_ADDR, 0x08, 1, &data);

	return (INT16) (data / 2 + 23); // 0.5 degrees per LSB, 23 degree K offset
}

INT16 AccelerometerInternal::ADAPT_Accel_reset( CLR_RT_HeapBlock* pMngObj, HRESULT &hr )
{
    INT16 retVal = 0; 
    return retVal;
}

INT16 AccelerometerInternal::ADAPT_Accel_advconfig( CLR_RT_HeapBlock* pMngObj, UINT32 param0, HRESULT &hr )
{
    INT16 retVal = 0; 
    return retVal;
}

INT16 AccelerometerInternal::ADAPT_Accel_SelfTest( CLR_RT_HeapBlock* pMngObj, HRESULT &hr )
{
    INT16 retVal = 0; 
    return retVal;
}

INT16 AccelerometerInternal::ADAPT_Accel_SetPowerMode( CLR_RT_HeapBlock* pMngObj, UINT32 param0, HRESULT &hr )
{
    INT16 retVal = 0; 
    return retVal;
}

INT16 AccelerometerInternal::ADAPT_Accel_SetBandwidth( CLR_RT_HeapBlock* pMngObj, UINT32 param0, HRESULT &hr )
{
    INT16 retVal = 0; 
    return retVal;
}

INT16 AccelerometerInternal::ADAPT_Accel_SetRange( CLR_RT_HeapBlock* pMngObj, UINT16 param0, HRESULT &hr )
{
    INT16 retVal = 0; 
    return retVal;
}

UINT16 AccelerometerInternal::ADAPT_Accel_Raw_Read( CLR_RT_HeapBlock* pMngObj, UINT16 param0, HRESULT &hr )
{
    INT16 retVal;
	UINT8 data;
	...
	samraksh_i2c_read_reg(BMA250_ADDR, (UINT8) param0, 1, &data);

    return data;
}

INT16 AccelerometerInternal::ADAPT_Accel_Raw_Write( CLR_RT_HeapBlock* pMngObj, UINT8 param0, UINT16 param1, HRESULT &hr )
{
    INT16 retVal;
	UINT8 data;
	...
	samraksh_i2c_write_reg(BMA250_ADDR, (UINT8) param0, (UINT8) param1);
