...
struct Library_spot_native_Samraksh_SPOT_Hardware_ADCInternal
{
...
{
    static const int FIELD_STATIC__AdcInternal = 6;
    static const int FIELD_STATIC__MyCallback = 7;
...
{
    static const int FIELD_STATIC__writeAddressPtr = 8;
    static const int FIELD_STATIC__readAddressPtr = 9;
    static const int FIELD_STATIC__startOfRecordDelimiter = 10;
    static const int FIELD_STATIC__endOfRecordDelimiter = 11;
    static const int FIELD_STATIC__startOfRecordInBytes = 12;
    static const int FIELD_STATIC__endOfRecordInBytes = 13;
    static const int FIELD_STATIC__maxSize = 14;
    static const int FIELD_STATIC__fullFlag = 15;
