...
// Moved this function out of the above macro definition - Nived.Sivadas/Jin
  __STATIC_INLINE uint32_t __CLZ(q31_t data)
    {
      uint32_t count = 0;
      uint32_t mask = 0x80000000;
   ...
   */
  // Added ARM_MATH_CM3 here - nived.sivadas / Jin
#if defined(ARM_MATH_CM0) || defined(ARM_MATH_CM3)
