...
const BlockRange STM32F10x_BlockRange_InternalFlash[] =
{
	   ...
	   // { BlockRange::BLOCKTYPE_BOOTSTRAP       ,  0, 63 },  // 64 blocks, 128K for Booter,     address 0x0000_0000
	    { BlockRange::BLOCKTYPE_CODE            , 0,199 },  //200 blocks, 400K for CLR,        address 0x0000_0000
	    { BlockRange::BLOCKTYPE_DEPLOYMENT      ,200,253 },  // 54 blocks, 108K for Deployment, address 0x06_4000
