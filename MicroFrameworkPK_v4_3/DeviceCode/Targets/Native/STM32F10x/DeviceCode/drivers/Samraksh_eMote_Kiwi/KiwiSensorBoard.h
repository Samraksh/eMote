...
struct Library_KiwiSensorBoard_Samraksh_eMote_SensorBoard_Buzzer
{
    TINYCLR_NATIVE_DECLARE(On___STATIC__BOOLEAN);
    TINYCLR_NATIVE_DECLARE(Off___STATIC__BOOLEAN);
