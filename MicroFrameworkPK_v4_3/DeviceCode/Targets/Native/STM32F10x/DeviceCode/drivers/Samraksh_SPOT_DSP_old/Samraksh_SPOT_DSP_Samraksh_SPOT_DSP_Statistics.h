...
#ifndef _SAMRAKSH_SPOT_DSP_SAMRAKSH_SPOT_DSP_STATISTICS_H_
#define _SAMRAKSH_SPOT_DSP_SAMRAKSH_SPOT_DSP_STATISTICS_H_
...
#endif  //_SAMRAKSH_SPOT_DSP_SAMRAKSH_SPOT_DSP_STATISTICS_H_
