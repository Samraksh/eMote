...
HRESULT Library_SamrakshEmoteDotNow_Samraksh_eMote_DotNow_NativeFileStream::_ctor___VOID__STRING__I4( CLR_RT_StackFrame& stack )
{
...
HRESULT Library_SamrakshEmoteDotNow_Samraksh_eMote_DotNow_NativeFileStream::Seek___I8__I8__U4( CLR_RT_StackFrame& stack )
{
    TINYCLR_HEADER(); hr = S_OK;
    {
        CLR_RT_HeapBlock* pMngObj = Interop_Marshal_RetrieveManagedObject( stack );
...
HRESULT Library_SamrakshEmoteDotNow_Samraksh_eMote_DotNow_NativeFileStream::Flush___VOID( CLR_RT_StackFrame& stack )
{
    TINYCLR_HEADER(); hr = S_OK;
    {
        CLR_RT_HeapBlock* pMngObj = Interop_Marshal_RetrieveManagedObject( stack );
...
HRESULT Library_SamrakshEmoteDotNow_Samraksh_eMote_DotNow_NativeFileStream::GetLength___I8( CLR_RT_StackFrame& stack )
{
    TINYCLR_HEADER(); hr = S_OK;
    {
        CLR_RT_HeapBlock* pMngObj = Interop_Marshal_RetrieveManagedObject( stack );
...
HRESULT Library_SamrakshEmoteDotNow_Samraksh_eMote_DotNow_NativeFileStream::SetLength___VOID__I8( CLR_RT_StackFrame& stack )
{
    TINYCLR_HEADER(); hr = S_OK;
    {
        CLR_RT_HeapBlock* pMngObj = Interop_Marshal_RetrieveManagedObject( stack );
...
HRESULT Library_SamrakshEmoteDotNow_Samraksh_eMote_DotNow_NativeFileStream::GetStreamProperties___VOID__BYREF_BOOLEAN__BYREF_BOOLEAN__BYREF_BOOLEAN( CLR_RT_StackFrame& stack )
{
    TINYCLR_HEADER(); hr = S_OK;
    {
        CLR_RT_HeapBlock* pMngObj = Interop_Marshal_RetrieveManagedObject( stack );
...
HRESULT Library_SamrakshEmoteDotNow_Samraksh_eMote_DotNow_NativeFileStream::Close___VOID( CLR_RT_StackFrame& stack )
{
    TINYCLR_HEADER(); hr = S_OK;
    {
        CLR_RT_HeapBlock* pMngObj = Interop_Marshal_RetrieveManagedObject( stack );
