    ...
    namespace eMote
    {
        namespace DotNow
        {
            struct ADCInternal
            {
                ...
                static INT32 ConfigureContinuousModeDualChannel( CLR_RT_TypedArray_UINT16 param0, CLR_RT_TypedArray_UINT16 param1, UINT32 param2, UINT32 param3, UINT32 param4, HRESULT &hr );
