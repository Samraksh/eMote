        ...
        namespace DotNow
        {
            struct VolumeInfo
            {
                ...
                static LPCSTR& Get_Name( CLR_RT_HeapBlock* pMngObj )    {
                	//return Interop_Marshal_GetField_LPCSTR( pMngObj, Library_SamrakshEmoteDotNow_Samraksh_eMote_DotNow_VolumeInfo::FIELD__Name );
                }

                static LPCSTR& Get_VolumeLabel( CLR_RT_HeapBlock* pMngObj )    {
                	//return Interop_Marshal_GetField_LPCSTR( pMngObj, Library_SamrakshEmoteDotNow_Samraksh_eMote_DotNow_VolumeInfo::FIELD__VolumeLabel );
                }
                ...
                static LPCSTR& Get_FileSystem( CLR_RT_HeapBlock* pMngObj )    {
                	//return Interop_Marshal_GetField_LPCSTR( pMngObj, Library_SamrakshEmoteDotNow_Samraksh_eMote_DotNow_VolumeInfo::FIELD__FileSystem );
                }
