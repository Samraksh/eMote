...
void NativeIO::Format( LPCSTR param0, LPCSTR param1, LPCSTR param2, UINT32 param3, HRESULT &hr )
{
}
...
UINT32 NativeIO::GetAttributes( LPCSTR path, HRESULT &hr )
{
	hal_printf("Inside NativeIO::GetAttributes\n");
	UINT32 attributes;
	//FAT_LogicDisk::GetAttributes(path, &attributes);
    UINT32 retVal = 0x80;
    return retVal;
}
