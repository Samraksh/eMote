...
// Nived.Sivadas : copied verbatim from STM32 processor project
// Useful for generating debug messages on hard faulting
void Fault_Handler_Display( UINT32 *registers,  UINT32 exception)
{
    int i;
