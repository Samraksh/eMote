...
#include "../IBL/CryptoInterface.h"

#include <Crypto.h>
#include "../IBL/ConfigurationManager.h"
//--//
...
bool CryptoState::VerifySignature( UINT32 keyIndex )
{
    ...
    case BlockRange::BLOCKTYPE_DEPLOYMENT:
        ...
        key = (BYTE*)g_PrimaryConfigManager.GetDeploymentKeys( ConfigurationSector::c_DeployKeyDeployment );
    ...
    default:
        ...
        key = (BYTE*)g_PrimaryConfigManager.GetDeploymentKeys( keyIndex );
    ...
    m_res = Crypto_GetHMAC( (BYTE*)m_dataAddress, m_dataLength, key, (BYTE*)m_sig, m_sigLength);
    ...
    if(memcmp(m_sig, hash, TINYBOOTER_SYMKEY_SIZE)==0)
    	return TRUE;
