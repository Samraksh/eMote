...
#define DEFINE_CMD4(cmd) { &CLR_DBG_Debugger::Emote_##cmd, CLR_DBG_Commands::c_Emote_##cmd }
...
const CLR_Messaging_CommandHandlerLookup c_Debugger_Lookup_Request[] =
{
    ...
    //
    DEFINE_CMD4(DynamicTestRunner_Process),
    DEFINE_CMD4(DynamicTestRunner_MallocByteBuffer),
    DEFINE_CMD4(DynamicTestRunner_ReadByteBuffer),
    DEFINE_CMD4(DynamicTestRunner_WriteByteBuffer),
    DEFINE_CMD4(DynamicTestRunner_FreeByteBuffer),
    DEFINE_CMD4(DynamicTestRunner_FreeAllBuffers),
    DEFINE_CMD4(DynamicTestRunner_ShowTests),
    DEFINE_CMD4(DynamicTestRunner_ShowByteBuffers),
