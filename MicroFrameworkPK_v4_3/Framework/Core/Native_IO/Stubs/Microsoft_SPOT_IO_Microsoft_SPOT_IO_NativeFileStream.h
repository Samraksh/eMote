...
#ifndef _MICROSOFT_SPOT_IO_MICROSOFT_SPOT_IO_NATIVEFILESTREAM_H_
#define _MICROSOFT_SPOT_IO_MICROSOFT_SPOT_IO_NATIVEFILESTREAM_H_
    ...
    namespace SPOT
    {
        namespace IO
        {
            struct NativeFileStream
            {
                ...
                static UNSUPPORTED_TYPE& Get_m_fs( CLR_RT_HeapBlock* pMngObj )    { return Interop_Marshal_GetField_UNSUPPORTED_TYPE( pMngObj, Library_Microsoft_SPOT_IO_Microsoft_SPOT_IO_NativeFileStream::FIELD__m_fs ); }
...
#endif  //_MICROSOFT_SPOT_IO_MICROSOFT_SPOT_IO_NATIVEFILESTREAM_H_
