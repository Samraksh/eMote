...
#define VIRT_TIMER_OMAC_FAST_RECOVERY	9
#define VIRT_TIMER_OMAC_RECEIVER_ACK 	10
...
//#define RF231_HW_ACK_RESP_TIME (GPIO_PIN)2 //24
...
#define SCHED_TX_EXEC_PIN (GPIO_PIN)30 //4
#define SCHED_RX_EXEC_PIN (GPIO_PIN)31 //4
