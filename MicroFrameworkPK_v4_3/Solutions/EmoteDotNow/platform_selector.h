...
#define RF231_START_OF_RX_MODE (GPIO_PIN)31 //24
#define RF231_GENERATE_HW_ACK	(GPIO_PIN)30
#define RF231_HW_ACK_RESP_TIME	(GPIO_PIN)120
#define CCA_PIN		(GPIO_PIN)120
#define RF231_RX_START	(GPIO_PIN)0
#define RF231_AMI		(GPIO_PIN)24
#define RF231_TRX_RX_END (GPIO_PIN)29
...
#define DATATX_PIN (GPIO_PIN)2 //29 //120 //120 //2							//J12_PIN3
...
#define DATATX_RECV_HW_ACK			(GPIO_PIN)4
#define FAST_RECOVERY_SEND	(GPIO_PIN)120 //(<--0)
#define DATATX_SEND_ACK_HANDLER	(GPIO_PIN)8
...
#define DATARECEPTION_SLOTPIN (GPIO_PIN)1 //30 //31 //2				//J12_PIN4

//Timesync related
#define TIMESYNC_GENERATE_MESSAGEPIN (GPIO_PIN)23 //25 //120 //24 //120// // 3 				//J11_pin6
...
#define VTIMER_CALLBACK_LATENCY_PIN	(GPIO_PIN)120 //(<--24)
