...
#define DATARECEPTION_SLOTPIN (GPIO_PIN)31 //2				//J12_PIN4

#define DATATX_PIN (GPIO_PIN)120 //120 //2							//J12_PIN3

#define DATATX_TIMESTAMP_PIN	(GPIO_PIN)24
#define DATATX_DATA_PIN			(GPIO_PIN)25
#define DATARX_TIMESTAMP_PIN	(GPIO_PIN)29
#define DATARX_DATA_PIN			(GPIO_PIN)30
#define SEND_ACK_PIN			(GPIO_PIN)120


#define DELAY_BETWEEN_DATATX_SCHED_ACTUAL	(GPIO_PIN)120	//J12_pin5

#define DISCO_SYNCSENDPIN (GPIO_PIN)120						//J12_PIN1
#define DISCO_SYNCRECEIVEPIN (GPIO_PIN)120					//J12_PIN2
...
#define RADIOCONTROL_STATEPIN (GPIO_PIN)120 // 120 //120 				//J11_pin6 //This (GPIO_PIN)3  did not work
