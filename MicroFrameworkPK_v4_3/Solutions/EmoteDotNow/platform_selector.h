...
#define SI4468_Radio_TX_Instance			(GPIO_PIN)23 //(GPIO_PIN)22 //(GPIO_PIN)120
...
#define DATATX_SendACKHandler_PIN_TOGGLER				(GPIO_PIN)22 //SCHED_TX_EXEC_PIN //(GPIO_PIN)120
