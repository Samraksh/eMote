...
#define SAM_VERSION_REVISION 17
...
#define DATARX_HANDLE_END_OF_RX			(GPIO_PIN)22
#define DATARX_SEND_SW_ACK				(GPIO_PIN)125//23//22
#define OMAC_DRIVING_RADIO_SEND			(GPIO_PIN)122//22
#define OMAC_DRIVING_RADIO_RECV			(GPIO_PIN)122//23
#define OMAC_DRIVING_RADIO_SLEEP		(GPIO_PIN)122//0
#define DATATX_RECV_SW_ACK				(GPIO_PIN)121//23
#define OMAC_DATARXPIN					(GPIO_PIN)125//24//0
...
#define SI4468_HANDLE_SLEEP				(GPIO_PIN)122//23
#define SI4468_HANDLE_INTERRUPT_TX		(GPIO_PIN)0//24
