...
#define OMAC_DISCO_BEACON_ACK_HANDLER_PIN	DISABLED_PIN // (GPIO_PIN)0 //DISABLED_PIN
#define OMAC_DISCO_BEACONNTIMERHANDLER_PIN	DISABLED_PIN // (GPIO_PIN)0 //DISABLED_PIN
...
#define LOCALCLOCKMONITORPIN 				(GPIO_PIN)25 //DISABLED_PIN //120 //22 //25
