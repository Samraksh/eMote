...
#define DEBUG_GPIO_EMOTE_AUSTERE 1
...
#define LOCALCLOCKMONITORPIN 				DISABLED_PIN //DISABLED_PIN //120 //22 //25
#define NEIGHBORCLOCKMONITORPIN 			AUSTERE_RADIO_GPIO_PIN // 120 //31 //2
#else
