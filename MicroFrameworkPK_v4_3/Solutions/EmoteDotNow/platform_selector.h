...
#define OMAC_DISCO_EXEC_EVENT				(GPIO_PIN)0 //DISABLED_PIN//23//0
...
#define OMAC_DISCO_BEACON_ACK_HANDLER_PIN	(GPIO_PIN)0 //DISABLED_PIN
#define OMAC_DISCO_BEACONNTIMERHANDLER_PIN	(GPIO_PIN)0 //DISABLED_PIN
...
#define DISCO_SYNCSENDPIN 					(GPIO_PIN)0 //DISABLED_PIN // 24  //120						//J12_PIN1
...
//RX related
#define OMAC_RXPIN 							(GPIO_PIN)25 //DISABLED_PIN //(GPIO_PIN)0 //120 //23  //120							//J11_pin3 0
//#define OMAC_DATARXPIN 	DISABLED_PIN //0 //26	//120 //2					//J12_pin5
#define OMAC_TIMESYNCREQRXPIN 				DISABLED_PIN //23 //30
#define DISCO_SYNCRECEIVEPIN 				(GPIO_PIN)0 //DISABLED_PIN // (GPIO_PIN)0 //DISABLED_PIN //25 //120					//J12_PIN2
