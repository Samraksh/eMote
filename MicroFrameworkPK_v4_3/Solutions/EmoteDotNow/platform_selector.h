...
#define VIRT_TIMER_INTERRUPT_CONTEXT_MARKER 9
...
#define DATATX_SendACKHandler_PIN_TOGGLER				DTH_STATE_PIN_TOGGLER //DISABLED_PIN //(GPIO_PIN)22 //SCHED_TX_EXEC_PIN //DISABLED_PIN
#define DATATX_ReceiveDATAACK_PIN_TOGGLER				DTH_STATE_PIN_TOGGLER // DISABLED_PIN //DISABLED_PIN
#define DATATX_CCA_PIN_TOGGLER				DISABLED_PIN
#define DATATX_TIMING_ERROR_PIN_TOGGLER 	DISABLED_PIN
#define DTH_STATE_PIN_TOGGLER				(GPIO_PIN)0 //DISABLED_PIN //SCHED_TX_EXEC_PIN
...
#define DISCO_SYNCRECEIVEPIN 				DISABLED_PIN // (GPIO_PIN)0 //DISABLED_PIN //25 //120					//J12_PIN2
#define DATARECEPTION_SLOTPIN 				(GPIO_PIN)25 //DISABLED_PIN //30 //31 //2				//J12_PIN4
...
#define SCHED_TX_EXEC_PIN 					DTH_STATE_PIN_TOGGLER //DISABLED_PIN //(GPIO_PIN)24 //24 //4
