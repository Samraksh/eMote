...
#define RADIOCONTROL_STATEPIN (GPIO_PIN)0 //120 //23 //120 // 120 //120 				//J11_pin6 //This (GPIO_PIN)3  did not work
#define DATATX_PIN (GPIO_PIN)2 //120 //120 //2							//J12_PIN3
#define DATATX_POSTEXEC			(GPIO_PIN)4
#define FAST_RECOVERY_SEND	(GPIO_PIN)8
#define RC_TX_DATA (GPIO_PIN)29
#define RF231_HW_ACK_RESP_TIME (GPIO_PIN)31 //24

#define RF231_SEND_FAIL	(GPIO_PIN)24
