...
#define SAM_VERSION_REVISION 39
...
#define NEIGHBORCLOCKMONITORPIN 			(GPIO_PIN)22 // 120 //31 //2
#define LOCALCLOCKMONITORPIN 				(GPIO_PIN)23 //120 //22 //25
...
#define SI4468_Radio_TX_Instance			SCHED_TX_EXEC_PIN //(GPIO_PIN)22 //(GPIO_PIN)120
...
#define OMAC_RADIOCONTROL_RADIO_SEND_TOGGLER			SI4468_Radio_TX_Instance //(GPIO_PIN)120
#define DATATX_SendACKHandler_PIN_TOGGLER				DTH_STATE_PIN_TOGGLER //SCHED_TX_EXEC_PIN //(GPIO_PIN)120
#define DATATX_ReceiveDATAACK_PIN_TOGGLER				DTH_STATE_PIN_TOGGLER //(GPIO_PIN)120
#define DATATX_CCA_PIN_TOGGLER				(GPIO_PIN)120
#define DATATX_TIMING_ERROR_PIN_TOGGLER 	(GPIO_PIN)120
#define DTH_STATE_PIN_TOGGLER			SCHED_TX_EXEC_PIN
...
#define SCHED_RX_EXEC_PIN 					(GPIO_PIN)25 //25 //4
#define SCHED_TX_EXEC_PIN 					(GPIO_PIN)24 //24 //4
