...
#define OMAC_RXPIN (GPIO_PIN)120					//J11-3

#define RADIOCONTROL_SEND_PIN (GPIO_PIN)120 		//J11-4
#define RADIOCONTROL_SENDTS_PIN (GPIO_PIN)120 	//J11-5
#define RADIOCONTROL_STATEPIN (GPIO_PIN)120 		//J11-6 //This (GPIO_PIN)3  did not work
