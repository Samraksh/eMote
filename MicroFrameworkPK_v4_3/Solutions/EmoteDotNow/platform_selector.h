...
#define DATATX_TIMESTAMP_PIN	(GPIO_PIN)120 //24 //Same as TIMESYNC_SENDPIN
...
#define DataRxInterrupt			(GPIO_PIN)0


#define DELAY_BETWEEN_DATATX_SCHED_ACTUAL	(GPIO_PIN)120	//J12_pin5

#define DISCO_SYNCSENDPIN (GPIO_PIN)24  //120						//J12_PIN1
#define DISCO_SYNCRECEIVEPIN (GPIO_PIN)25 //120					//J12_PIN2
