...
#define DATATX_DATA_PIN					(GPIO_PIN)120//22
#define DATARX_SEND_SW_ACK				(GPIO_PIN)121//22
#define OMAC_DRIVING_RADIO_SEND			(GPIO_PIN)22
#define OMAC_DRIVING_RADIO_RECV			(GPIO_PIN)23
#define OMAC_DRIVING_RADIO_SLEEP		(GPIO_PIN)0
...
#define SI4468_HANDLE_INTERRUPT_TX		(GPIO_PIN)24
