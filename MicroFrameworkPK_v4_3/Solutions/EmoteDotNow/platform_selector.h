...
#define NEIGHBORCLOCKMONITORPIN (GPIO_PIN)25 //120 //25 // 120 //31 //2
#define LOCALCLOCKMONITORPIN (GPIO_PIN)24 //120 //24 //120 //22 //25
...
#define TIMESYNC_RECEIVEPIN (GPIO_PIN)0 //24 			//J12_pin5
...
#define DATA_RX_INTERRUPT_PIN	(GPIO_PIN)31
