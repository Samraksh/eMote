...
#define RF231_HW_ACK_RESP_TIME (GPIO_PIN)120 //24
#define CCA_PIN		(GPIO_PIN)120


//Acknowledgements from radio
#define SEND_ACK_PIN			(GPIO_PIN)120 //29//120
#define DATA_RX_INTERRUPT_PIN	(GPIO_PIN)23 //120
#define DATA_TX_ACK_PIN			(GPIO_PIN)29 //120

//Acknowledgements from other node
#define OMAC_TX_DATAACK_PIN (GPIO_PIN)0 //120 //120 //23  //120							//J11_pin3 0
#define OMAC_RX_DATAACK_PIN (GPIO_PIN)23 //120 // 120 //23  //120							//J11_pin3 0
