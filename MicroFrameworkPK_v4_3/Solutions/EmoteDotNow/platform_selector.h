...
#define RC_TX_DATA (GPIO_PIN)29//29
...
#define FAST_RECOVERY_SEND	(GPIO_PIN)0
...
//Scheduler Related
#define SCHED_START_STOP_PIN (GPIO_PIN)23 //4
...
#define SCHED_TSREQ_EXEC_PIN (GPIO_PIN)25 //23 //4
...
#define VTIMER_CALLBACK_LATENCY_PIN	(GPIO_PIN)24
