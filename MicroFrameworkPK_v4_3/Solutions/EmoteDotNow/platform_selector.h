...
//#define HW_ACK_PIN				(GPIO_PIN)0
#define SCHED_DISCO_EXEC_PIN (GPIO_PIN)120 //4
#define DATARECEPTION_SLOTPIN (GPIO_PIN)1 //31 //2				//J12_PIN4
#define RF231_HW_ACK_RESP_TIME (GPIO_PIN)0 //24
//#define DATATX_PIN (GPIO_PIN)3 //120 //120 //2							//J12_PIN3
#define DATATX_PIN (GPIO_PIN)2 //120 //120 //2							//J12_PIN3
#define OMAC_RX_DATAACK_PIN (GPIO_PIN)120
...
#define SCHED_TSREQ_EXEC_PIN (GPIO_PIN)120 //4
#define DATA_TX_ACK_PIN			(GPIO_PIN)23
#define RC_TX_TIMESYNCREQ (GPIO_PIN)120
#define RADIOCONTROL_STATEPIN (GPIO_PIN)24 //120 //23 //120 // 120 //120 				//J11_pin6 //This (GPIO_PIN)3  did not work
#define RC_TX_DATA (GPIO_PIN)29
#define SCHED_TX_EXEC_PIN (GPIO_PIN)120 //4
#define SCHED_RX_EXEC_PIN (GPIO_PIN)120 //4
#define CCA_PIN		(GPIO_PIN)31
//#define OMAC_RXPIN (GPIO_PIN)31 //120 //23  //120							//J11_pin3 0
#define DATA_RX_INTERRUPT_PIN	(GPIO_PIN)30	//0
