...
#define SAM_VERSION_REVISION 21
...
#define DATATX_DATA_PIN					(GPIO_PIN)125//24//22
#define DATARX_HANDLE_END_OF_RX			(GPIO_PIN)0615//22
#define OMAC_CONTINUATION				(GPIO_PIN)0616//23
#define DATARX_SEND_SW_ACK				(GPIO_PIN)125//23//22
#define OMAC_DRIVING_RADIO_SEND			(GPIO_PIN)122//22
#define DATARX_EXEC_EVENT				(GPIO_PIN)06161405//22//23
#define SI4468_HANDLE_SLEEP				(GPIO_PIN)06162115//0//23
#define SCHED_RX_EXEC_PIN 				(GPIO_PIN)06171015//22
#define OMAC_DISCO_EXEC_EVENT			(GPIO_PIN)06171015//23//0
#define EMOTE_NET_MAC_GETNEXTPACKET		(GPIO_PIN)22
#define EMOTE_NET_MANAGED_CALLBACK		(GPIO_PIN)23//0
#define OMAC_DATARXPIN					(GPIO_PIN)24//0
#define OMAC_DRIVING_RADIO_RECV			(GPIO_PIN)0616//22//23
#define OMAC_DRIVING_RADIO_SLEEP		(GPIO_PIN)0615//22//0
#define OMAC_SCHED_POST_POST_EXEC		(GPIO_PIN)0615//22//0
#define OMAC_DISCO_POST_EXEC			(GPIO_PIN)0616//23//0
#define DATATX_RECV_SW_ACK				(GPIO_PIN)121//23
...
#define SI4468_HANDLE_INTERRUPT_TX		(GPIO_PIN)0615//0//24
#define SI4468_MEASURE_RX_TIME			(GPIO_PIN)0//23
#define SI4468_HANDLE_INTERRUPT_RX		(GPIO_PIN)25//0
