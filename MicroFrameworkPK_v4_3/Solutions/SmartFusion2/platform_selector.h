...
#define GPIO_COMPUTE_PROCESSOR_DATA_TO_SEND 2
#define GPIO_EXTERNAL_POWER 4
...
#define VIRT_TIMER_PERIODIC_CP_STATUS	13
/********CSMAMAC SPECIFIC VIRTUAL TIMERS AND VARIABLES********/
#define VIRT_TIMER_MAC_SENDPKT 		14
#define VIRT_TIMER_MAC_BEACON 		15
#define VIRT_TIMER_MAC_FLUSHBUFFER 	16
/********CSMAMAC SPECIFIC VIRTUAL TIMERS AND VARIABLES********/

/********OMAC SPECIFIC VIRTUAL TIMERS AND VARIABLES********/
#define VIRT_TIMER_OMAC_SCHEDULER_FAILSAFE 23
