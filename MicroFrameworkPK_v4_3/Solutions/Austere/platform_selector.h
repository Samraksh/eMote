...
#ifndef _PLATFORM_Austere_SELECTOR_H_
#define _PLATFORM_Austere_SELECTOR_H_ 1
...
#define PLATFORM_DEPENDENT_TX_USART_BUFFER_SIZE    1500  // there is one TX for each usart port
...
#define VIRT_TIMER_MAC_DATAACKFAIL 	16
/********CSMAMAC SPECIFIC VIRTUAL TIMERS AND VARIABLES********/

/********OMAC SPECIFIC VIRTUAL TIMERS AND VARIABLES********/
#define VIRT_TIMER_OMAC_SCHEDULER_FAILSAFE 17
#define VIRT_TIMER_OMAC_SCHEDULER_RADIO_STOP_RETRY 30
#define VIRT_TIMER_OMAC_DISCOVERY	18
#define VIRT_TIMER_OMAC_TIMESYNC 	19
#define VIRT_TIMER_OMAC_RECEIVER 	20
#define VIRT_TIMER_OMAC_TRANSMITTER	21
//#define VIRT_TIMER_OMAC_TX_EXECEVENT	8
#define VIRT_TIMER_OMAC_FAST_RECOVERY	22
#define VIRT_TIMER_OMAC_POST_EXEC	23
...
#endif // _PLATFORM_Austere_SELECTOR_H_
