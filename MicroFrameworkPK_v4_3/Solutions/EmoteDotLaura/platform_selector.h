...
//General purpose test pins, used only in tests in testsuite, so can be reused in multiple tests
//assuming two tests dont run at the same time
...
/*
//Samraksh Fthr module board
#define TEST_PIN0 (GPIO_PIN)47
#define TEST_PIN1 (GPIO_PIN)48
#define TEST_PIN2 (GPIO_PIN)24
#define TEST_PIN3 (GPIO_PIN)25
#define TEST_PIN4 (GPIO_PIN)46
#define TEST_PIN5 (GPIO_PIN)45
#define TEST_PIN6 (GPIO_PIN)43
#define TEST_PIN7 (GPIO_PIN)27
#define TEST_PIN8 (GPIO_PIN)26
#define TEST_PIN9 (GPIO_PIN)29
#define TEST_PIN1 (GPIO_PIN)28
*/
