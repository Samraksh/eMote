...
//--//
#ifndef _DRIVERS_BLOCKSTORAGEDRIVER_SOC_ADAPT_H_
#define _DRIVERS_BLOCKSTORAGEDRIVER_SOC_ADAPT_H_ 1

//--//

struct SOC_ADAPT_BlockStorage_Driver
{
...
#endif // _DRIVERS_BLOCKSTORAGEDRIVER_SOC_ADAPT_H_
