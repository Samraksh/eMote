    ...
    namespace SPOT
    {
        namespace Hardware
        {
            struct OneWire
            {
                ...
                static INT32 FindFirstDevice( CLR_RT_HeapBlock* pMngObj, INT8 param0, INT8 param1, HRESULT &hr );
                static INT32 FindNextDevice( CLR_RT_HeapBlock* pMngObj, INT8 param0, INT8 param1, HRESULT &hr );
