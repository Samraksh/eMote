    ...
    namespace SPOT
    {
        namespace Hardware
        {
            struct HardwareProvider
            {
                ...
                static INT32 NativeGetAnalogOutputChannelsCount( CLR_RT_HeapBlock* pMngObj, HRESULT &hr );
                static INT32 NativeGetAnalogOutputPinForChannel( CLR_RT_HeapBlock* pMngObj, INT32 param0, HRESULT &hr );
                static INT32 NativeGetAvailableAnalogOutputPrecisionInBitsForChannel( CLR_RT_HeapBlock* pMngObj, INT32 param0, HRESULT &hr );
            };
        }
    }
}
