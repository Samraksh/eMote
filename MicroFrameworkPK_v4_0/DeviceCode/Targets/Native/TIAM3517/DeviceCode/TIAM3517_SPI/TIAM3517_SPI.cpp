/*
 *  Name : TIAM3517_SPI.cpp
 *
 *  Author : nathan.stohs@samraksh.com
 *
 *  Description : contains the core implementation of the spi driver
 *
 *
 */
...
BOOL TIAM3517_SPI_Driver::Xaction_Start( const SPI_CONFIGURATION& Configuration )
{
	...
	//t &= ~(OMAP3_SPI_CHxCONF_PHA_D); 		// SPI Phase 		// SPI Phase
	t &= ~(OMAP3_SPI_CHxCONF_CLKD_CLR); 	// Clear clock divider
	t |= OMAP3_SPI_CHxCONF_CLKD_32768; 		// 8192 CLK divider
