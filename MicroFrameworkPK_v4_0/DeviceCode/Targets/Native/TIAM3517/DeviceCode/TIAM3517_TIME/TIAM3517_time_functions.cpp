...
{
    return TIAM3517_TIME_Driver::Initialize();
}

BOOL HAL_Time_Uninitialize()
{
    return TIAM3517_TIME_Driver::Uninitialize();
}

UINT64 HAL_Time_CurrentTicks()
{
    return TIAM3517_TIME_Driver::CounterValue();
}
...
{
    return TIAM3517_TIME_Driver::TicksToTime( Ticks );
}

INT64 HAL_Time_CurrentTime()
{
    return TIAM3517_TIME_Driver::CurrentTime();
}

void HAL_Time_SetCompare( UINT64 CompareValue )
{
    TIAM3517_TIME_Driver::SetCompareValue( CompareValue );
}
