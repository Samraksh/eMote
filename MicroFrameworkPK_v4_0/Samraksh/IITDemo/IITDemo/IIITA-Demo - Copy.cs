...
namespace PDRTracking
{
    public class PDRTracking
    {
		...
		{
			public static int HALF = 6434;
			public static int FULL = 12868;
			public static int NEG = -12868;
			public static int TWO = 25736;
        ...
        static void sampleFired(object o)
        {
            ...
            if (SensorData.sampNum >= (int)DETECTOR.SAMPRATE * (int)DETECTOR.DC_EST_SECS)
            {
                ...
                SensorData.tempPhase = Phase.unwrap(SensorData.compSample)  >> 12;
