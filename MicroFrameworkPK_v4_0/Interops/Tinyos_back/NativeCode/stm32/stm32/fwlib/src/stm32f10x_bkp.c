...
void BKP_TamperPinLevelConfig(uint16_t BKP_TamperPinLevel)
{
  ...
  *(volatile uint32_t *) CR_TPAL_BB = BKP_TamperPinLevel;
}
...
void BKP_TamperPinCmd(FunctionalState NewState)
{
  ...
  *(volatile uint32_t *) CR_TPE_BB = (uint32_t)NewState;
}
...
void BKP_ITConfig(FunctionalState NewState)
{
  ...
  *(volatile uint32_t *) CSR_TPIE_BB = (uint32_t)NewState;
}
...
void BKP_WriteBackupRegister(uint16_t BKP_DR, uint16_t Data)
{
  ...
  *(volatile uint16_t *) (BKP_BASE + BKP_DR) = Data;
}
...
uint16_t BKP_ReadBackupRegister(uint16_t BKP_DR)
{
  ...
  return (*(volatile uint16_t *) (BKP_BASE + BKP_DR));
}
...
{
  return (FlagStatus)(*(volatile uint32_t *) CSR_TEF_BB);
}
...
{
  return (ITStatus)(*(volatile uint32_t *) CSR_TIF_BB);
}
