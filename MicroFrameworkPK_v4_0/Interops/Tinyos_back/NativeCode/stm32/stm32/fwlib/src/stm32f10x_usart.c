...
/*---------------------------- USART CR2 Configuration -----------------------*/
  ...
  tmpreg |= (uint32_t)USART_InitStruct->USART_StopBits | USART_InitStruct->USART_Clock |
...
/*---------------------------- USART BRR Configuration -----------------------*/
  ...
  if ((*(uint32_t*)&USARTx) == USART1_BASE)
  {
...
{
  uint32_t bitpos = 0x00, itmask = 0x00, usartreg = 0;
