...
#define CR1_OPM_Mask                ((uint16_t)0x03F7)
...
#define CR2_CCDS_Reset              ((uint16_t)0x00F0)
#define CR2_MMS_Mask                ((uint16_t)0x0080)
#define CR2_TI1S_Set                ((uint16_t)0x0080)
#define CR2_TI1S_Reset              ((uint16_t)0xFF70)

#define SMCR_SMS_Mask               ((uint16_t)0xFFF0)
#define SMCR_ETR_Mask               ((uint16_t)0x00F7)
#define SMCR_TS_Mask                ((uint16_t)0xFF87)
#define SMCR_MSM_Mask               ((uint16_t)0xFF77)
...
#define CCMR_OC13FE_Mask            ((uint16_t)0xFFFB)
#define CCMR_OC24FE_Mask            ((uint16_t)0xFBFF)
#define CCMR_OC13PE_Mask            ((uint16_t)0xFFF7)
#define CCMR_OC24PE_Mask            ((uint16_t)0xF7FF)
#define CCMR_OCM13_Mask             ((uint16_t)0xFF8F)
#define CCMR_OCM24_Mask             ((uint16_t)0x8FFF)

#define CCMR_OC13CE_Mask            ((uint16_t)0xFF7F)
#define CCMR_OC24CE_Mask            ((uint16_t)0x7FFF)
...
#define CCER_CC1P_Mask              ((uint16_t)0x3331)
#define CCER_CC2P_Mask              ((uint16_t)0x3313)
#define CCER_CC3P_Mask              ((uint16_t)0x3133)
#define CCER_CC4P_Mask              ((uint16_t)0x1333)

#define CCER_CC1E_Set               ((uint16_t)0x0001)
#define CCER_CC1E_Reset             ((uint16_t)0x3332)
#define CCER_CC1E_Mask              ((uint16_t)0x3332)

#define CCER_CC2E_Set               ((uint16_t)0x0010)
#define CCER_CC2E_Reset             ((uint16_t)0x3323)
#define CCER_CC2E_Mask              ((uint16_t)0x3323)

#define CCER_CC3E_Set               ((uint16_t)0x0100)
#define CCER_CC3E_Reset             ((uint16_t)0x3233)
#define CCER_CC3E_Mask              ((uint16_t)0x3233)

#define CCER_CC4E_Set               ((uint16_t)0x1000)
#define CCER_CC4E_Reset             ((uint16_t)0x2333)
#define CCER_CC4E_Mask              ((uint16_t)0x2333)

#define DCR_DMA_Mask                ((uint16_t)0x0000)

/* TIM private Masks */
#define TIM_Period_Reset_Mask       ((uint16_t)0x0000)
#define TIM_Prescaler_Reset_Mask    ((uint16_t)0x0000)
#define TIM_Pulse_Reset_Mask        ((uint16_t)0x0000)
#define TIM_ICFilter_Mask           ((uint8_t)0x00)

/* Private macro -------------------------------------------------------------*/
/* Private variables ---------------------------------------------------------*/
static const uint16_t Tab_OCModeMask[4] = {0xFF00, 0x00FF, 0xFF00, 0x00FF};
static const uint16_t Tab_PolarityMask[4] = {CCER_CC1P_Mask, CCER_CC2P_Mask, CCER_CC3P_Mask, CCER_CC4P_Mask};
...
void TIM_OCInit(TIM_TypeDef* TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
  ...
  if ((TIM_OCInitStruct->TIM_Channel == (uint16_t)TIM_Channel_1) ||
      (TIM_OCInitStruct->TIM_Channel == (uint16_t)TIM_Channel_2))
  {
    tmpccmrx = TIMx->CCMR1;
  ...
  else 
  {
    ...
    { 
      ...
      TIMx->CCMR2 = (uint16_t)tmpccmrx;
    }
  }
  
  TIMx->CCER = (uint16_t)tmpccer;
}
...
void TIM_DMACmd(TIM_TypeDef* TIMx, uint16_t TIM_DMASource, FunctionalState Newstate)
{
  ...
  else
  {
    ...
    tmpdier &= (uint16_t)(~TIM_DMASource);
  }
  TIMx->DIER = (uint16_t)tmpdier;
}
...
void TIM_ETRClockMode2Config(TIM_TypeDef* TIMx, uint16_t TIM_ExtTRGPrescaler, 
                             uint16_t TIM_ExtTRGPolarity, uint8_t ExtTRGFilter)
{
  /* Check the parameters */
  assert_param(IS_TIM_EXT_PRESCALER(TIM_ExtTRGPrescaler));
  assert_param(IS_TIM_EXT_POLARITY(TIM_ExtTRGPolarity));
                       ...
                       uint8_t ExtTRGFilter)
{
  ...
  tmpsmcr |= TIM_ExtTRGPrescaler | TIM_ExtTRGPolarity | (uint16_t)((uint16_t)ExtTRGFilter << 8);

  TIMx->SMCR = (uint16_t)tmpsmcr;
}
                                ...
                                uint16_t TIM_IC1Polarity, uint16_t TIM_IC2Polarity)
{
  ...
  tmpccer |= (TIM_IC1Polarity | (uint16_t)((uint16_t)TIM_IC2Polarity << 4));
...
void TIM_OC2PolarityConfig(TIM_TypeDef* TIMx, uint16_t TIM_OCPolarity)
{
  ...
  tmpccer |= (uint16_t)((uint16_t)TIM_OCPolarity << 4);
...
void TIM_OC3PolarityConfig(TIM_TypeDef* TIMx, uint16_t TIM_OCPolarity)
{
  ...
  tmpccer |= (uint16_t)((uint16_t)TIM_OCPolarity << 8);
...
void TIM_OC4PolarityConfig(TIM_TypeDef* TIMx, uint16_t TIM_OCPolarity)
{
  ...
  tmpccer |= (uint16_t)((uint16_t)TIM_OCPolarity << 12);
...
void TIM_SetIC2Prescaler(TIM_TypeDef* TIMx, uint16_t TIM_IC2Prescaler)
{
  ...
  tmpccmr1 |= (uint16_t)((uint16_t)TIM_IC2Prescaler << 8);
...
void TIM_SetIC4Prescaler(TIM_TypeDef* TIMx, uint16_t TIM_IC4Prescaler)
{
  ...
  tmpccmr2 |= (uint16_t)((uint16_t)TIM_IC4Prescaler << 8);
...
static void PWMI_Config(TIM_TypeDef* TIMx, TIM_ICInitTypeDef* TIM_ICInitStruct)
{
  uint8_t ICPolarity = TIM_ICPolarity_Rising;
  uint8_t ICSelection = TIM_ICSelection_DirectTI;
                       ...
                       uint8_t TIM_ICFilter)
{
  ...
  tmpccmr1 |= TIM_ICSelection | (uint16_t)((uint16_t)TIM_ICFilter << 4);
                       ...
                       uint8_t TIM_ICFilter)
{
  ...
  tmpccmr1 = TIMx->CCMR1;
  tmpccer = TIMx->CCER;
  tmp = (uint16_t)((uint16_t)TIM_ICPolarity << 4);
  ...
  tmpccmr1 |= (uint16_t)((uint16_t)TIM_ICFilter << 12);
  tmpccmr1 |= (uint16_t)((uint16_t)TIM_ICSelection << 8);
                       ...
                       uint8_t TIM_ICFilter)
{
  ...
  tmpccmr2 = TIMx->CCMR2;
  tmpccer = TIMx->CCER;
  tmp = (uint16_t)((uint16_t)TIM_ICPolarity << 8);
  ...
  tmpccmr2 |= TIM_ICSelection | (uint16_t)((uint16_t)TIM_ICFilter << 4);
                       ...
                       uint8_t TIM_ICFilter)
{
  ...
  tmpccmr2 = TIMx->CCMR2;
  tmpccer = TIMx->CCER;
  tmp = (uint16_t)((uint16_t)TIM_ICPolarity << 12);
  ...
  tmpccmr2 |= (uint16_t)((uint16_t)TIM_ICSelection << 8) | (uint16_t)((uint16_t)TIM_ICFilter << 12);
