...
/* TIM1 CR1 Mask */
#define CR1_CounterMode_Mask                ((uint16_t)0x039F)
#define CR1_CKD_Mask                        ((uint16_t)0x00FF)

/* TIM1 CR2 Mask */
#define CR2_MMS_Mask                        ((uint16_t)0x0080)

/* TIM1 SMCR Mask */
#define SMCR_SMS_Mask                       ((uint16_t)0xFFF0)
#define SMCR_ETR_Mask                       ((uint16_t)0x40F7)
#define SMCR_TS_Mask                        ((uint16_t)0xFF87)
#define SMCR_ECE_Set                        ((uint16_t)0x0001)
...
#define CCMR_OCM13_Mask                     ((uint16_t)0x7F0F)
#define CCMR_OCM24_Mask                     ((uint16_t)0x0F7F)
...
#define OC13Mode_Mask		                ((uint16_t)0xFF00)
#define OC24Mode_Mask		                ((uint16_t)0x00FF)

/* TIM1 CCER Set/Reset Bit */
#define CCER_CCE_Set                        ((uint16_t)0x0001)
#define CCER_CCE_Reset                      ((uint16_t)0x0000)

/* TIM1 DMA Mask */
#define DCR_DMA_Mask                        ((uint16_t)0x0000)

/* TIM1 private Masks */
#define TIM1_Period_Reset_Mask               ((uint16_t)0xFFFF)
#define TIM1_Prescaler_Reset_Mask            ((uint16_t)0x0000)
#define TIM1_RepetitionCounter_Reset_Mask    ((uint16_t)0x0000)
#define TIM1_Pulse_Reset_Mask                ((uint16_t)0x0000)
#define TIM1_ICFilter_Mask                   ((uint8_t)0x00)
#define TIM1_DeadTime_Reset_Mask             ((uint16_t)0x0000)

/* Private macro -------------------------------------------------------------*/
/* Private variables ---------------------------------------------------------*/
/* Private function prototypes -----------------------------------------------*/
static void TI1_Config(uint16_t TIM1_ICPolarity, uint16_t TIM1_ICSelection,
                       uint8_t TIM1_ICFilter);
static void TI2_Config(uint16_t TIM1_ICPolarity, uint16_t TIM1_ICSelection,
                       uint8_t TIM1_ICFilter);
static void TI3_Config(uint16_t TIM1_ICPolarity, uint16_t TIM1_ICSelection,
                       uint8_t TIM1_ICFilter);
static void TI4_Config(uint16_t TIM1_ICPolarity, uint16_t TIM1_ICSelection,
                       uint8_t TIM1_ICFilter);
...
void TIM1_TimeBaseInit(TIM1_TimeBaseInitTypeDef* TIM1_TimeBaseInitStruct)
{
 /* Check the parameters */
  ...
  TIM1->CR1 |= (uint32_t)TIM1_TimeBaseInitStruct->TIM1_ClockDivision |
...
void TIM1_OC1Init(TIM1_OCInitTypeDef* TIM1_OCInitStruct)
{
  ...
  *(volatile uint32_t *) CCER_CC1E_BB = CCER_CCE_Reset;
  ...
  *(volatile uint32_t *) CCER_CC1E_BB = TIM1_OCInitStruct->TIM1_OutputState;

  /* Set the Output N State */
  *(volatile uint32_t *) CCER_CC1NE_BB = TIM1_OCInitStruct->TIM1_OutputNState;

  /* Set the Output Polarity */
  *(volatile uint32_t *) CCER_CC1P_BB = TIM1_OCInitStruct->TIM1_OCPolarity;

  /* Set the Output N Polarity */
  *(volatile uint32_t *) CCER_CC1NP_BB = TIM1_OCInitStruct->TIM1_OCNPolarity;

  /* Set the Output Idle state */
  *(volatile uint32_t *) CR2_OIS1_BB = TIM1_OCInitStruct->TIM1_OCIdleState;

  /* Set the Output N Idle state */
  *(volatile uint32_t *) CR2_OIS1N_BB = TIM1_OCInitStruct->TIM1_OCNIdleState;
...
void TIM1_OC2Init(TIM1_OCInitTypeDef* TIM1_OCInitStruct)
{
  ...
  *(volatile uint32_t *) CCER_CC2E_BB = CCER_CCE_Reset;

  /* Reset the Output Compare Bits */
   tmpccmr &= OC24Mode_Mask;

  /* Set the Ouput Compare Mode */
  tmpccmr |= (uint32_t)TIM1_OCInitStruct->TIM1_OCMode << 8;

  TIM1->CCMR1 = (uint16_t)tmpccmr;

  /* Set the Output State */
  *(volatile uint32_t *) CCER_CC2E_BB = TIM1_OCInitStruct->TIM1_OutputState;

  /* Set the Output N State */
  *(volatile uint32_t *) CCER_CC2NE_BB = TIM1_OCInitStruct->TIM1_OutputNState;

  /* Set the Output Polarity */
  *(volatile uint32_t *) CCER_CC2P_BB = TIM1_OCInitStruct->TIM1_OCPolarity;

  /* Set the Output N Polarity */
  *(volatile uint32_t *) CCER_CC2NP_BB = TIM1_OCInitStruct->TIM1_OCNPolarity;

  /* Set the Output Idle state */
  *(volatile uint32_t *) CR2_OIS2_BB = TIM1_OCInitStruct->TIM1_OCIdleState;

  /* Set the Output N Idle state */
  *(volatile uint32_t *) CR2_OIS2N_BB = TIM1_OCInitStruct->TIM1_OCNIdleState;
...
void TIM1_OC3Init(TIM1_OCInitTypeDef* TIM1_OCInitStruct)
{
  ...
  *(volatile uint32_t *) CCER_CC3E_BB = CCER_CCE_Reset;
  ...
  /* Set the Output State */
  *(volatile uint32_t *) CCER_CC3E_BB = TIM1_OCInitStruct->TIM1_OutputState;

  /* Set the Output N State */
  *(volatile uint32_t *) CCER_CC3NE_BB = TIM1_OCInitStruct->TIM1_OutputNState;

  /* Set the Output Polarity */
  *(volatile uint32_t *) CCER_CC3P_BB = TIM1_OCInitStruct->TIM1_OCPolarity;

  /* Set the Output N Polarity */
  *(volatile uint32_t *) CCER_CC3NP_BB = TIM1_OCInitStruct->TIM1_OCNPolarity;

  /* Set the Output Idle state */
  *(volatile uint32_t *) CR2_OIS3_BB = TIM1_OCInitStruct->TIM1_OCIdleState;

  /* Set the Output N Idle state */
  *(volatile uint32_t *) CR2_OIS3N_BB = TIM1_OCInitStruct->TIM1_OCNIdleState;
...
void TIM1_OC4Init(TIM1_OCInitTypeDef* TIM1_OCInitStruct)
{
  ...
  *(volatile uint32_t *) CCER_CC4E_BB = CCER_CCE_Reset;
  ...
  TIM1->CCMR2 = (uint16_t)tmpccmr;

  /* Set the Output State */
  *(volatile uint32_t *) CCER_CC4E_BB = TIM1_OCInitStruct->TIM1_OutputState;

  /* Set the Output Polarity */
  *(volatile uint32_t *) CCER_CC4P_BB = TIM1_OCInitStruct->TIM1_OCPolarity;

  /* Set the Output Idle state */
  *(volatile uint32_t *) CR2_OIS4_BB = TIM1_OCInitStruct->TIM1_OCIdleState;
...
void TIM1_BDTRConfig(TIM1_BDTRInitTypeDef *TIM1_BDTRInitStruct)
{
  ...
  tmpbdtr = (uint32_t)TIM1_BDTRInitStruct->TIM1_OSSRState | TIM1_BDTRInitStruct->TIM1_OSSIState |
...
void TIM1_Cmd(FunctionalState NewState)
{
  ...
  *(volatile uint32_t *) CR1_CEN_BB = (uint16_t)NewState;
}
...
void TIM1_CtrlPWMOutputs(FunctionalState Newstate)
{
  ...
  *(volatile uint32_t *) BDTR_MOE_BB = (uint16_t)Newstate;
}
...
void TIM1_DMACmd(uint16_t TIM1_DMASource, FunctionalState Newstate)
{
  ...
  else
  {
    ...
    tmpdier &= (uint16_t)~TIM1_DMASource;
  }
  TIM1->DIER = (uint16_t)tmpdier;
}
                             ...
                             uint16_t ExtTRGFilter)
{
  ...
  *(volatile uint32_t *) SMCR_ECE_BB = SMCR_ECE_Set;
}
                    ...
                    uint16_t ExtTRGFilter)
{
  ...
  tmpsmcr |= TIM1_ExtTRGPrescaler | TIM1_ExtTRGPolarity | (uint16_t)((uint16_t)ExtTRGFilter << 8);

  TIM1->SMCR = (uint16_t)tmpsmcr;
}
...
* Return         : None
*******************************************************************************/
void TIM1_TIxExternalClockConfig(uint16_t TIM1_TIxExternalCLKSource,
                                uint16_t TIM1_ICPolarity, uint8_t ICFilter)
{
  /* Check the parameters */
...
void TIM1_UpdateDisableConfig(FunctionalState Newstate)
{
  ...
  *(volatile uint32_t *) CR1_UDIS_BB = (uint16_t)Newstate;
}
...
void TIM1_UpdateRequestConfig(uint8_t TIM1_UpdateSource)
{
  ...
  *(volatile uint32_t *) CR1_URS_BB = TIM1_UpdateSource;
}
...
void TIM1_SelectHallSensor(FunctionalState Newstate)
{
  ...
  *(volatile uint32_t *) CR2_TI1S_BB = (uint16_t)Newstate;
}
...
void TIM1_SelectOnePulseMode(uint16_t TIM1_OPMode)
{
  ...
  *(volatile uint32_t *) CR1_OPM_BB = TIM1_OPMode;
}
...
void TIM1_SelectMasterSlaveMode(uint16_t TIM1_MasterSlaveMode)
{
  ...
  *(volatile uint32_t *) SMCR_MSM_BB = TIM1_MasterSlaveMode;
}
                                ...
                                uint16_t TIM1_IC2Polarity)
{
  ...
  *(volatile uint32_t *) CCER_CC1P_BB = TIM1_IC1Polarity;
  *(volatile uint32_t *) CCER_CC2P_BB = TIM1_IC2Polarity;

  TIM1->SMCR = (uint16_t)tmpsmcr;

  TIM1->CCMR1 = (uint16_t)tmpccmr1;
}
...
void TIM1_PrescalerConfig(uint16_t Prescaler, uint16_t TIM1_PSCReloadMode)
{
  ...
  *(volatile uint32_t *) EGR_UG_BB = TIM1_PSCReloadMode;
}
/*******************************************************************************
...
void TIM1_ForcedOC2Config(uint16_t TIM1_ForcedAction)
{
  ...
  /* Configure The Forced output Mode */
  tmpccmr1 |= (uint32_t)TIM1_ForcedAction << 8;
...
void TIM1_ForcedOC4Config(uint16_t TIM1_ForcedAction)
{
  ...
  /* Configure The Forced output Mode */
  tmpccmr2 |= (uint16_t)((uint16_t)TIM1_ForcedAction << 8);
...
void TIM1_ARRPreloadConfig(FunctionalState Newstate)
{
  ...
  *(volatile uint32_t *) CR1_ARPE_BB = (uint16_t)Newstate;
}
...
void TIM1_SelectCOM(FunctionalState Newstate)
{
  ...
  *(volatile uint32_t *) CR2_CCUS_BB = (uint16_t)Newstate;
}
...
void TIM1_SelectCCDMA(FunctionalState Newstate)
{
  ...
  *(volatile uint32_t *) CR2_CCDS_BB = (uint16_t)Newstate;
}
...
void TIM1_CCPreloadControl(FunctionalState Newstate)
{
  ...
  *(volatile uint32_t *) CR2_CCPC_BB = (uint16_t)Newstate;
}
...
void TIM1_OC1PreloadConfig(uint16_t TIM1_OCPreload)
{
  ...
  *(volatile uint32_t *) CCMR1_OC1PE_BB = (uint16_t)TIM1_OCPreload;
}
...
void TIM1_OC2PreloadConfig(uint16_t TIM1_OCPreload)
{
  ...
  *(volatile uint32_t *) CCMR1_OC2PE_BB = (uint16_t)TIM1_OCPreload;
}
...
void TIM1_OC3PreloadConfig(uint16_t TIM1_OCPreload)
{
  ...
  *(volatile uint32_t *) CCMR2_OC3PE_BB = (uint16_t)TIM1_OCPreload;
}
...
void TIM1_OC4PreloadConfig(uint16_t TIM1_OCPreload)
{
  ...
  *(volatile uint32_t *) CCMR2_OC4PE_BB = (uint16_t)TIM1_OCPreload;
}
...
void TIM1_OC1FastConfig(uint16_t TIM1_OCFast)
{
  ...
  *(volatile uint32_t *) CCMR1_OC1FE_BB = (uint16_t)TIM1_OCFast;
}
...
void TIM1_OC2FastConfig(uint16_t TIM1_OCFast)
{
  ...
  *(volatile uint32_t *) CCMR1_OC2FE_BB = (uint16_t)TIM1_OCFast;
}
...
void TIM1_OC3FastConfig(uint16_t TIM1_OCFast)
{
  ...
  *(volatile uint32_t *) CCMR2_OC3FE_BB = (uint16_t)TIM1_OCFast;
}
...
void TIM1_OC4FastConfig(uint16_t TIM1_OCFast)
{
  ...
  *(volatile uint32_t *) CCMR2_OC4FE_BB = (uint16_t)TIM1_OCFast;
}
...
void TIM1_ClearOC1Ref(uint16_t TIM1_OCClear)
{
  ...
  *(volatile uint32_t *) CCMR1_OC1CE_BB = (uint16_t)TIM1_OCClear;
}
...
void TIM1_ClearOC2Ref(uint16_t TIM1_OCClear)
{
  ...
  *(volatile uint32_t *) CCMR1_OC2CE_BB = (uint16_t)TIM1_OCClear;
}
...
void TIM1_ClearOC3Ref(uint16_t TIM1_OCClear)
{
  ...
  *(volatile uint32_t *) CCMR2_OC3CE_BB = (uint16_t)TIM1_OCClear;
}
...
void TIM1_ClearOC4Ref(uint16_t TIM1_OCClear)
{
  ...
  *(volatile uint32_t *) CCMR2_OC4CE_BB = (uint16_t)TIM1_OCClear;
}
...
void TIM1_OC1PolarityConfig(uint16_t TIM1_OCPolarity)
{
  ...
  *(volatile uint32_t *) CCER_CC1P_BB = (uint16_t)TIM1_OCPolarity;
}
...
void TIM1_OC1NPolarityConfig(uint16_t TIM1_OCNPolarity)
{
  ...
  *(volatile uint32_t *) CCER_CC1NP_BB = (uint16_t)TIM1_OCNPolarity;
}
...
void TIM1_OC2PolarityConfig(uint16_t TIM1_OCPolarity)
{
  ...
  *(volatile uint32_t *) CCER_CC2P_BB = (uint16_t)TIM1_OCPolarity;
}
...
void TIM1_OC2NPolarityConfig(uint16_t TIM1_OCNPolarity)
{
  ...
  /* Set or Reset the CC3P Bit */
  *(volatile uint32_t *) CCER_CC2NP_BB = (uint16_t)TIM1_OCNPolarity;
}
...
void TIM1_OC3PolarityConfig(uint16_t TIM1_OCPolarity)
{
  ...
  /* Set or Reset the CC3P Bit */
  *(volatile uint32_t *) CCER_CC3P_BB = (uint16_t)TIM1_OCPolarity;
}
...
void TIM1_OC3NPolarityConfig(uint16_t TIM1_OCNPolarity)
{
  ...
  /* Set or Reset the CC3P Bit */
  *(volatile uint32_t *) CCER_CC3NP_BB = (uint16_t)TIM1_OCNPolarity;
}
...
void TIM1_OC4PolarityConfig(uint16_t TIM1_OCPolarity)
{
  ...
  *(volatile uint32_t *) CCER_CC4P_BB = (uint16_t)TIM1_OCPolarity;
}
...
void TIM1_CCxCmd(uint16_t TIM1_Channel, FunctionalState Newstate)
{
  ...
  if(TIM1_Channel == TIM1_Channel_1)
  {
    ...
    *(volatile uint32_t *) CCER_CC1E_BB = (uint16_t)Newstate;  
  }
  else if(TIM1_Channel == TIM1_Channel_2)
  {
    /* Set or Reset the CC2E Bit */
    *(volatile uint32_t *) CCER_CC2E_BB = (uint16_t)Newstate;
  }
  else if(TIM1_Channel == TIM1_Channel_3)
  {
    /* Set or Reset the CC3E Bit */
    *(volatile uint32_t *) CCER_CC3E_BB = (uint16_t)Newstate;
  }
  else
  {
    /* Set or Reset the CC4E Bit */
    *(volatile uint32_t *) CCER_CC4E_BB = (uint16_t)Newstate;
  }
}
...
void TIM1_CCxNCmd(uint16_t TIM1_Channel, FunctionalState Newstate)
{
  ...
  if(TIM1_Channel == TIM1_Channel_1)
  {
    ...
    *(volatile uint32_t *) CCER_CC1NE_BB = (uint16_t)Newstate;  
  }
  else if(TIM1_Channel == TIM1_Channel_2)
  {
    /* Set or Reset the CC2NE Bit */
    *(volatile uint32_t *) CCER_CC2NE_BB = (uint16_t)Newstate;
  }
  else 
  {
    /* Set or Reset the CC3NE Bit */
    *(volatile uint32_t *) CCER_CC3NE_BB = (uint16_t)Newstate;
  }
}
...
void TIM1_SelectOCxM(uint16_t TIM1_Channel, uint16_t TIM1_OCMode)
{
  ...
  else if(TIM1_Channel == TIM1_Channel_2)
  {
    ...
    *(volatile uint32_t *) CCER_CC2E_BB = CCER_CCE_Reset;
    ...
    /* Set the Ouput Compare Mode */
    TIM1->CCMR1 |= (uint16_t)((uint16_t)TIM1_OCMode << 8);
  }
  else if(TIM1_Channel == TIM1_Channel_3)
  {
    /* Disable the Channel 3: Reset the CCE Bit */
  ...
  else
  {
    ...
    *(volatile uint32_t *) CCER_CC4E_BB = CCER_CCE_Reset;
    ...
    /* Set the Ouput Compare Mode */
    TIM1->CCMR2 |= (uint16_t)((uint16_t)TIM1_OCMode << 8);
  }
}
...
void TIM1_SetIC2Prescaler(uint16_t TIM1_IC2Prescaler)
{
  ...
  tmpccmr1 |= (uint16_t)((uint16_t)TIM1_IC2Prescaler << 8);
...
void TIM1_SetIC4Prescaler(uint16_t TIM1_IC4Prescaler)
{
  ...
  tmpccmr2 |= (uint16_t)((uint16_t)TIM1_IC4Prescaler << 8);
...
FlagStatus TIM1_GetFlagStatus(uint16_t TIM1_FLAG)
{
  ...
  if ((TIM1->SR & TIM1_FLAG) != (uint16_t)RESET )
  {
    bitstatus = SET;
  }
  else
...
ITStatus TIM1_GetITStatus(uint16_t TIM1_IT)
{
  ...
  uint16_t TIM1_itStatus = 0x0, TIM1_itEnable = 0x0;
  ...
  if ((TIM1_itStatus != (uint16_t)RESET ) && (TIM1_itEnable != (uint16_t)RESET ))
  {
    bitstatus = SET;
  }
  else
                       ...
                       uint8_t TIM1_ICFilter)
{
  ...
  *(volatile uint32_t *) CCER_CC1E_BB = CCER_CCE_Reset;
  ...
  tmpccmr1 |= (uint16_t)TIM1_ICSelection | (uint16_t)((uint16_t)TIM1_ICFilter << 4);

  TIM1->CCMR1 = (uint16_t)tmpccmr1;

  /* Select the Polarity */
  *(volatile uint32_t *) CCER_CC1P_BB = TIM1_ICPolarity;

  /* Set the CCE Bit */
  *(volatile uint32_t *) CCER_CC1E_BB = CCER_CCE_Set;
}
                       ...
                       uint8_t TIM1_ICFilter)
{
  ...
  *(volatile uint32_t *) CCER_CC2E_BB = CCER_CCE_Reset;
  ...
  tmpccmr1 |= (uint16_t)((uint16_t)TIM1_ICSelection << 8) | (uint16_t)((uint16_t)TIM1_ICFilter <<12);

  TIM1->CCMR1 = (uint16_t)tmpccmr1;

  /* Select the Polarity */
  *(volatile uint32_t *) CCER_CC2P_BB = TIM1_ICPolarity;

  /* Set the CCE Bit */
  *(volatile uint32_t *) CCER_CC2E_BB = CCER_CCE_Set;
                       ...
                       uint8_t TIM1_ICFilter)
{
  ...
  *(volatile uint32_t *) CCER_CC3E_BB = CCER_CCE_Reset;
  ...
  tmpccmr2 |= (uint16_t)TIM1_ICSelection | (uint16_t)((uint16_t)TIM1_ICFilter << 4);

  TIM1->CCMR2 = (uint16_t)tmpccmr2;

  /* Select the Polarity */
  *(volatile uint32_t *) CCER_CC3P_BB = TIM1_ICPolarity;

  /* Set the CCE Bit */
  *(volatile uint32_t *) CCER_CC3E_BB = CCER_CCE_Set;
}
                       ...
                       uint8_t TIM1_ICFilter)
{
  ...
  *(volatile uint32_t *) CCER_CC4E_BB = CCER_CCE_Reset;
  ...
  tmpccmr2 |= (uint16_t)((uint16_t)TIM1_ICSelection << 8) | (uint16_t)((uint16_t)TIM1_ICFilter << 12);

  TIM1->CCMR2 = (uint16_t)tmpccmr2;

  /* Select the Polarity */
  *(volatile uint32_t *) CCER_CC4P_BB = TIM1_ICPolarity;

  /* Set the CCE Bit */
  *(volatile uint32_t *) CCER_CC4E_BB = CCER_CCE_Set;
}
