...
HRESULT Library_InterfaceLibrary_Samraksh_ADC::Init___STATIC__I4__I4( CLR_RT_StackFrame& stack )
{
    TINYCLR_HEADER(); hr = S_OK;
    {
        ...
        INT32 retVal = ADC::Init( param0, hr );
...
HRESULT Library_InterfaceLibrary_Samraksh_ADC::getData___STATIC__I4__SZARRAY_U2__U4__U4( CLR_RT_StackFrame& stack )
{
    TINYCLR_HEADER(); hr = S_OK;
    {
        ...
        INT32 retVal = ADC::getData( param0, param1, param2, hr );
        TINYCLR_CHECK_HRESULT( hr );
        SetResult_INT32( stack, retVal );
