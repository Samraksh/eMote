    ...
    public class SocketExceptionTests : IMFTestInterface
    {
        ...
        public MFTestResults SocketExceptionTest3_Protocol_Address_FamilyNotSupported()
        {
            ...
            try
            {
                ...
                {
                    if (e.ErrorCode.ToString() !=
                        SocketError.ProtocolFamilyNotSupported.ToString()
                        && e.ErrorCode.ToString() !=
                        SocketError.AddressFamilyNotSupported.ToString())
                        throw new System.Exception("Incorrect ErrorCode in SocketException "
                            + e.ErrorCode, e);
                    isAnyCatch = true;
                }
        ...
        public MFTestResults SocketExceptionTest4_ProtocolNotSupported()
        {
            ...
            try
            {
                ...
                {
                    if (e.ErrorCode.ToString() != SocketError.ProtocolNotSupported.ToString())
                        throw new System.Exception("Incorrect ErrorCode in SocketException "
                            + e.ErrorCode, e);
                    isAnyCatch = true;
                }
        ...
        public MFTestResults SocketExceptionTest6_IsConnected()
        {
            ...
            try
            {
                ...
                {
                    if (e.ErrorCode.ToString() != SocketError.IsConnected.ToString() && e.ErrorCode.ToString() != SocketError.InvalidArgument.ToString())
                        throw new System.Exception("Incorrect ErrorCode in SocketException "
                            + e.ErrorCode, e);
                    isCorrectCatch = true;
                    isAnyCatch = true;
        ...
        public MFTestResults SocketExceptionTest11_AccessDenied()
        {
            ...
            try
            {
                ...
                {
                    if (e.ErrorCode.ToString() != SocketError.AccessDenied.ToString() && e.ErrorCode.ToString() != SocketError.AddressAlreadyInUse.ToString())
                        throw new System.Exception("Incorrect ErrorCode in SocketException " +
                            e.ErrorCode, e);
                    isCorrectCatch = true;
                    isAnyCatch = true;
        ...
        public MFTestResults SocketExceptionTest12_NotConnected()
        {
            ...
            try
            {
                ...
                {
                    if (e.ErrorCode.ToString() != SocketError.NotConnected.ToString())
                        throw new System.Exception("Incorrect ErrorCode in SocketException " +
                            e.ErrorCode, e);
                    isCorrectCatch = true;
                    isAnyCatch = true;
        ...
        public MFTestResults SocketExceptionTest13_InvalidArgument()
        {
            ...
            try
            {
                ...
                {
                    //Different error codes from different OS's .  The InvalidArgument comes from Vista.  The AccessDenied comes from 2003 Server.
                    if (e.ErrorCode.ToString() != SocketError.InvalidArgument.ToString() && e.ErrorCode.ToString() != SocketError.AccessDenied.ToString())
                        throw new System.Exception("Incorrect ErrorCode in SocketException " +
                            e.ErrorCode, e);
                    isCorrectCatch = true;
                    isAnyCatch = true;
        ...
        public MFTestResults SocketExceptionTest14_AddressNotAvailable()
        {
            ...
            try
            {
                ...
                {
                    if ((e.ErrorCode.ToString() != SocketError.AddressNotAvailable.ToString()) && (e.ErrorCode != 10022))
                        throw new System.Exception("Incorrect ErrorCode in SocketException "
                            + e.ErrorCode, e);
                    isCorrectCatch = true;
                    isAnyCatch = true;
        ...
        public MFTestResults SocketExceptionTest16_HostNotFound()
        {
            ...
            try
            {
                ...
                {
                    if (e.ErrorCode.ToString() != SocketError.HostNotFound.ToString() && e.ErrorCode.ToString() != SocketError.SocketError.ToString())
                        throw new System.Exception("Incorrect ErrorCode in SocketException " + 
                            e.ErrorCode, e);
                    isCorrectCatch = true;
                    isAnyCatch = true;
        ...
        public MFTestResults SocketExceptionTest17_SocketError()
        {
            ...
            {
                if (e.ErrorCode.ToString() != SocketError.ProtocolNotSupported.ToString() && e.ErrorCode.ToString() != SocketError.SocketError.ToString())
                    Log.Comment("Incorrect exception caught: " + e.Message);
                else
                    isCorrectCatch = true;
            }
        ...
        public MFTestResults SocketExceptionTest18_Fault()
        {
            ...
            try
            {
                ...
                {
                    if (e.ErrorCode.ToString() != SocketError.Fault.ToString())
                        throw new System.Exception("Incorrect ErrorCode in SocketException "
                            + e.ErrorCode, e);
                    isCorrectCatch = true;
                    isAnyCatch = true;
        ...
        public MFTestResults SocketExceptionTest19_ProtocolOption()
        {
            ...
            try
            {
                ...
                {
                    if (e.ErrorCode.ToString() != SocketError.ProtocolOption.ToString())
                        throw new System.Exception("Incorrect ErrorCode in SocketException "
                            + e.ErrorCode, e);
                    isCorrectCatch = true;
                    isAnyCatch = true;
        ...
        public MFTestResults SocketExceptionTest20_OperationNotSupported()
        {
            ...
            try
            {
                ...
                {
                    if (e.ErrorCode.ToString() != SocketError.OperationNotSupported.ToString())
                        throw new System.Exception("Incorrect ErrorCode in SocketException "
                            + e.ErrorCode, e);
                    isCorrectCatch = true;
                    isAnyCatch = true;
