...
namespace Microsoft.SPOT.Platform.Tests
{
    ...
    public class FileInfoTests : IMFTestInterface
    {
        ...
        public MFTestResults FileInfoTest_CreationTime0()
        {
            ...
            try
            {
                FileStream file = File.Create("FileInfoTest_CreationTime0.txt");
                file.Close();

                FileInfo fi = new FileInfo("FileInfoTest_CreationTime0.txt");
        ...
        public MFTestResults FileInfoTest_LastAccessTime0()
        {
            ...
            try
            {
                FileStream file = File.Create("FileInfoTest_LastAccessTime0.txt");
                file.Close();

                FileInfo fi = new FileInfo("FileInfoTest_LastAccessTime0.txt");
                testResult = (fi.LastAccessTime.Ticks != 0);
            }
            catch (Exception ex)
            {
                Log.Exception("Unexpected Exception", ex);
        ...
        public MFTestResults FileInfoTest_LastWriteTime0()
        {
            ...
            try
            {
                FileStream file = File.Create("FileInfoTest_LastWriteTime0.txt");
                file.Close();

                FileInfo fi = new FileInfo("FileInfoTest_LastWriteTime0.txt");
                testResult = (fi.LastWriteTime.Ticks != 0);
            }
            catch (Exception ex)
            {
                Log.Exception("Unexpected Exception", ex);
