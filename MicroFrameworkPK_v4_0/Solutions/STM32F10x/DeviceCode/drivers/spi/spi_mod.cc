...
//
//	// Nived: Moved from the else section of the code
//	SPI_XACTION_8 Transaction;
//
...
//	else
//	{
//		// Nived: Moving this to beginning of the code
//		//SPI_XACTION_8 Transaction;
//
//		Transaction.Read8 = Read8;
//		Transaction.ReadCount = ReadCount;
...
//        Transaction.WriteCount = WriteCount;
//        Transaction.SPI_mod = Configuration.SPI_mod;
//        Transaction.BusyPin = Configuration.BusyPin; //FIXME the Pin parameter is junk as of now, state is 0 though
//
//		//data_send = *Transaction.Write8;
//
//		//CPU_GPIO_EnableOutputPin(Configuration.DeviceCS, false);
//		
...
//		//SPI_I2S_SendData(SPI_mod, data_send); //TODO:	Need to check on the cast, just casting as of now
//	
//		//while (SPI_I2S_GetFlagStatus(SPI_mod, SPI_I2S_FLAG_RXNE) == RESET);        
//		//data_recv = SPI_I2S_ReceiveData(SPI_mod);		
//		//*Transaction.Read8 = (UINT8)SPI_I2S_ReceiveData(SPI_mod);		
//		
//		//if(Read8 != NULL)
//			//*Transaction.Read8 = SPI_I2S_ReceiveData(SPI_mod);		
//		//	*Transaction.Read8 = data_recv;		
//
//		//LED_BLUE();
//
//		//ptr_data_recv = &data_recv;
//		//Read8[0] = *ptr_data_recv;
//		//ptr_data_recv = &data_recv;
//		//Read8[0] = data_recv;
//		
//		//data_recv = data_recv + 1;
//
//		//CPU_GPIO_SetPinState(Configuration.DeviceCS, true);
//
//		//data_send = *Transaction.Write8;
//
//		////CPU_GPIO_EnableOutputPin(Configuration.DeviceCS, false);
