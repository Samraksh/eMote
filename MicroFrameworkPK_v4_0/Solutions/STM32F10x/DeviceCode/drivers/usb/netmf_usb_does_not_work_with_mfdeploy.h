...
#define DATA_OUT                  1       /* Data Out state */
#define DATA_IN                   2       /* Data In state */
#define DATA_IN_LAST              3       /* Last Data In Last */
...
//#define MASS_SIZ_STRING_VENDOR            16
//#define MASS_SIZ_STRING_PRODUCT           38
//#define MASS_SIZ_STRING_PRODUCT           12
...
const uint8_t MASS_StringInterface[MASS_SIZ_STRING_INTERFACE] =
  {
    ...
    0x03,
    /* Interface 0: "ST Mass" */
    //'S', 0, 'A', 0, 'M', 0, 'R', 0, 'A', 0, 'K', 0, 'S', 0, 'H', 0
