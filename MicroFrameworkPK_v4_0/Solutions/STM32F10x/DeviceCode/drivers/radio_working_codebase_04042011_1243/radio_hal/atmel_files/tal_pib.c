...
static UINT8 limit_tx_pwr(UINT8 tal_pib_TransmitPower);
static UINT8 convert_phyTransmitPower_to_reg_value(UINT8 phyTransmitPower_value);
...
void write_all_tal_pib_to_trx(void)
{
    ...
    /* configure RX_AACK */
    pal_trx_reg_write(RG_PAN_ID_0, (UINT8)tal_pib_PANId);
    pal_trx_reg_write(RG_PAN_ID_1, (UINT8)(tal_pib_PANId >> 8));

    ptr_to_reg = (UINT8 *)&tal_pib_IeeeAddress;
    for (UINT8 i = 0; i < 8; i++)
    {
    ...
    pal_trx_reg_write(RG_SHORT_ADDR_0, (UINT8)tal_pib_ShortAddress);
    pal_trx_reg_write(RG_SHORT_ADDR_1, (UINT8)(tal_pib_ShortAddress >> 8));
...
retval_t tal_pib_get(UINT8 attribute, UINT8 *value)
{
    switch (attribute)
    {
        ...
        case macPANId:
            *(UINT16 *)value = tal_pib_PANId;
            break;
#ifdef PROMISCUOUS_MODE
        case macPromiscuousMode:
            *(UINT16 *)value = tal_pib_PromiscuousMode;
            break;
#endif
        case macShortAddress:
            *(UINT16 *)value = tal_pib_ShortAddress;
            break;
        ...
        case phyChannelsSupported:
            *(UINT32 *)value = tal_pib_SupportedChannels;
            break;
        ...
        case phyMaxFrameDuration:
            *(UINT16 *)value = tal_pib_MaxFrameDuration;
            break;
        ...
        case macIeeeAddress:
            *(UINT64 *)value = tal_pib_IeeeAddress;
            break;
#ifdef BEACON_SUPPORT
        case macBattLifeExt:
        ...
        case macBeaconTxTime:
            *(UINT32 *)value = tal_pib_BeaconTxTime;
            break;
#endif  /* BEACON_SUPPORT */
        ...
        default:
            ...
            switch (attribute)
            {
                ...
                case phyCurrentChannel:
                    ...
                    if ((UINT32)TRX_SUPPORTED_CHANNELS & ((UINT32)0x01 << value->pib_value_8bit))
                    {
...
static UINT8 limit_tx_pwr(UINT8 tal_pib_TransmitPower)
{
    UINT8 ret_val = tal_pib_TransmitPower;
    int8_t dbm_value;
