 ...
 * Beacon order.
 */
UINT8 tal_pib_BeaconOrder;

/**
 * Superframe order.
 */
UINT8 tal_pib_SuperFrameOrder;

/**
 * Holds the time at which last beacon was transmitted or received.
 */
UINT32 tal_pib_BeaconTxTime;
#endif  /* BEACON_SUPPORT */
