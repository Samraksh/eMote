...
void        LCD_Init(void);                                                       // needs to be started once
void        LCD_Draw_Surface    ( u8 x , u8 y , u8 width, u8 height, u16 color ); // drawing surface
void        LCD_Draw_Rectangle  ( u8 x , u8 y , u8 width, u8 height, u16 color ); // drawing rectangle
void        LCD_Draw_Line       ( u8 x1, u8 y1, u8 x2   , u8 y2    , u16 color ); // Draw line
void        LCD_Delite_Line     ( u8 x1, u8 y1, u8 x2   , u8 y2                ); // restore delete line painted against the background image

void        LCD_Draw_BW_Image   ( u8 x , u8 y , u8 width, u8 height, const u8*  imageptr ); // draw black and white picture
void        LCD_Draw_Color_Image( u8 x , u8 y , u8 width, u8 height, const u16* imageptr ); // Draw color image

void        LCD_Write_Text      ( u8 x , u8 y , const u8* Text, u8 Text_Len    ); // Write text, textsetup see Font.c
...
void LCD_Write_Text( u8 x, u8 y, const u8* Text, u8 Text_Len )
{
   u8 ref_x = x, i , c;
