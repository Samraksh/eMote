...
#include <tinyhal.h>
#include "BlockStorageDriver_FX.h"
...
UINT32 __section(SectionForFlashOperations)STUB_BlockStorage_Driver::MaxSectorWrite_uSec( void* context )
{
    return 1;
}


UINT32 __section(SectionForFlashOperations)STUB_BlockStorage_Driver::MaxBlockErase_uSec( void* context )
{
    return 1;
