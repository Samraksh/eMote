...
namespace Microsoft.SPOT.Sample
{
    public class SampleApplication : Microsoft.SPOT.Application
    {
        ...
        public Window CreateUI()
        {
            ...
            window.AddHandler(Buttons.ButtonDownEvent, new ButtonEventHandler(OnButtonDown), false);
            window.AddHandler(Buttons.GotFocusEvent, new FocusChangedEventHandler(OnGotFocus), false);
