    ...
    namespace SPOT
    {
        namespace Hardware
        {
            struct SPI
            {
                ...
                static void InternalWriteRead( CLR_RT_HeapBlock* pMngObj, CLR_RT_TypedArray_UINT16 param0, INT32 param1, CLR_RT_TypedArray_UINT16 param2, INT32 param3, HRESULT &hr );
                static void InternalWriteRead( CLR_RT_HeapBlock* pMngObj, CLR_RT_TypedArray_UINT8 param0, INT32 param1, CLR_RT_TypedArray_UINT8 param2, INT32 param3, HRESULT &hr );
            };
        }
    }
}
