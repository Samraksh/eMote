...
namespace Microsoft
{
    namespace SPOT
    {
        struct ExtendedTimer
        {
            ...
            static void Change( CLR_RT_HeapBlock* pMngObj, UNSUPPORTED_TYPE param0, UNSUPPORTED_TYPE param1, HRESULT &hr );
            static void Change( CLR_RT_HeapBlock* pMngObj, INT32 param0, UNSUPPORTED_TYPE param1, HRESULT &hr );
            static UNSUPPORTED_TYPE get_LastExpiration( CLR_RT_HeapBlock* pMngObj, HRESULT &hr );
        };
    }
}
