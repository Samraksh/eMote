    ...
    public class ServicesTests : IMFTestInterface
    {
        ...
        public MFTestResults ServicesTest_DPWSHostedService_Properties()
        {
            ...
            try
            {
                ...
                if (testDHS.BodyParts != null)
                    if (testDHS.BodyParts.GetType() !=
                        Type.GetType("Ws.Services.Mtom.WsMtomBodyParts"))
                        throw new Exception("BodyParts wrong type");

                testDHS.BodyParts = new Ws.Services.Mtom.WsMtomBodyParts();
                if (testDHS.BodyParts != null)
                    if (testDHS.BodyParts.GetType() !=
                        Type.GetType("Ws.Services.Mtom.WsMtomBodyParts"))
