...
namespace Microsoft.SPOT.Platform.Tests
{
    class TestService : DpwsHostedService
    {
        ...
        public byte[] TwoWayResponse(WsWsaHeader header, int sum)
        {
            ...
            // Write namespaces
            xmlWriter.WriteAttributeString("xmlns", "wsdp", null, WsWellKnownUri.WsdpNamespaceUri);
            xmlWriter.WriteAttributeString("xmlns", "wsd", null, WsWellKnownUri.WsdNamespaceUri);
