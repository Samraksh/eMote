    ...
    class EventSimulator
    {
        ...
        public void SendEvent(Object stateInfo)
        {
            ...
            try
            {
                ...
                Device.SubscriptionManager.FireEvent(m_hostedService, eventSource, header, BuildSimpleEventMessage(m_hostedService));
            }
            catch
            {
                //Log.Comment("");
            ...
            try
            {
                ...
                Device.SubscriptionManager.FireEvent(m_hostedService, eventSource, header, BuildIntegerEventMessage(m_hostedService));
            }
            catch
            {
                //Log.Comment("");
