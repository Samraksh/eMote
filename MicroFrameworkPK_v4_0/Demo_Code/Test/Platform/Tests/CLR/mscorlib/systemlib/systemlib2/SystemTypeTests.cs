    ...
    public class SystemTypeTests : IMFTestInterface
    {
        ...
        public MFTestResults SystemType7_GetField_Test()
        {
            ...
            try
            {
                ...
                Type myType1 = Type.GetType("System.Int32");
                Log.Comment("The full name is " + myType1.FullName);
                testResult &= (myType1.GetField("data1") == null);
                ...
                testResult &= fInfo_m_Data.Equals( fInfo_m_data );
                if (!testResult) { Log.Exception(" Last test failed "); }
        ...
        public MFTestResults SystemType8_GetFields_Test()
        {
            ...
            //    Type myType2 = testTestObject2.GetType();
            //    Log.Comment("The full name is " + myType2.FullName);
            //    testResult &= (myType2.GetField("data1").FieldType == myType1);
            //    testResult &= ((int)myType2.GetField("data1").GetValue(testTestObject2) == 5);
            //    testResult &= (myType2.GetField("data1").MemberType == MemberTypes.Field);
            //    testResult &= (myType2.GetField("data1").Name == "data1");
            //    myType2.GetField("data1").SetValue(testTestObject2, 6);
            //    testResult &= ((int)myType2.GetField("data1").GetValue(testTestObject2) == 6);
            //}
            //catch (Exception e)
            //{
        ...
        public MFTestResults SystemType9_GetInterfaces_Test()
        {
            ...
            //    Log.Comment("The full name is " + myType2.FullName);
            //    Type myType3 = 
            //        Type.GetType("Microsoft.SPOT.Platform.Tests.SystemTypeTests+testInter");
