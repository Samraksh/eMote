...
namespace Microsoft.SPOT.Platform.Tests
{
    ...
    public class DirectoryInfoTests : IMFTestInterface
    {
        ...
        public MFTestResults DirectoryInfoTest_LastAccessTime0()
        {
            ...
            try
            {
                Directory.CreateDirectory("DirectoryInfoTest_LastAccessTime0");

                DirectoryInfo fi = new DirectoryInfo("DirectoryInfoTest_LastAccessTime0");
        ...
        public MFTestResults DirectoryInfoTest_LastWriteTime0()
        {
            ...
            try
            {
                Directory.CreateDirectory("DirectoryInfoTest_LastWriteTime0");

                DirectoryInfo fi = new DirectoryInfo("DirectoryInfoTest_LastWriteTime0");
