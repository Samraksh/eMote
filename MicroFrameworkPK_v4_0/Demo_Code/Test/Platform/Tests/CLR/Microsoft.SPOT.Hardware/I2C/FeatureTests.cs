...
namespace Microsoft.SPOT.Platform.Tests
{
    ...
    public class EEPROM_I2C
    {
        ...
        {
            byte[] readBuffer = { 0x0 };
            I2CDevice.I2CReadTransaction read = I2C_device.CreateReadTransaction(readBuffer);
        ...
        public byte RandomByteRead(ushort address)
        {
            ...
            //
            I2CDevice.I2CReadTransaction read = I2C_device.CreateReadTransaction(readBuffer);
            I2CDevice.I2CWriteTransaction writeCounter = I2C_device.CreateWriteTransaction(dummyAddress);
        ...
        public void WriteByte(ushort address, byte data)
        {
            ...
            I2CDevice.I2CWriteTransaction write = I2C_device.CreateWriteTransaction(writeBuffer);
        ...
        public void WritePage(ushort Address, EEPROM_I2C_Page EEPROM_Page)
        {
            ...
            byte[] dummyAddress = { HighAddress(Address), LowAddress(Address) };
            I2CDevice.I2CWriteTransaction writeCounter = I2C_device.CreateWriteTransaction(dummyAddress);
            I2CDevice.I2CWriteTransaction pageWrite = I2C_device.CreateWriteTransaction(EEPROM_Page.Page());
