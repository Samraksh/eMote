...
void CLR_HW_Hardware::ProcessActivity()
{
    ...
    HAL_CONTINUATION::Dequeue_And_Execute(); //Calls the Continuations.cpp in AsyncProc Calls
    ...
    UINT32 events    = ::Events_Get( m_wakeupEvents );    //Calls events.cpp in pal/events
    UINT32 eventsCLR = 0;
